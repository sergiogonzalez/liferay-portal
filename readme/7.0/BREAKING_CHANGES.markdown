...
This affects developers that use this method to get the OrderByComparator
object to order the WikiPages.

#### How should I update my code?

You should update your code to call:

- `WikiPortletUtil.getPageOrderByComparator(String, String)`:

#### Why was this change made?

As part of the modularization efforts, and due this method is only used in wiki
web we consider that this it the right place to put this method.