...
<div class="closed container-fluid-1280 sidenav-container sidenav-right" id="<portlet:namespace />infoPanelId">
	...
	<c:if test="<%= dlPortletInstanceSettingsHelper.isShowActions() && !portletTitleBasedNavigation %>">
		<div class="btn-group">
			...
			<liferay-frontend:management-bar-sidenav-toggler-button cssClass="btn btn-default" href="javascript:;" label='<%= LanguageUtil.get(resourceBundle, "info") %>' sidenavId='<%= liferayPortletResponse.getNamespace() + "infoPanelId" %>' />
		</div>
	</c:if>
