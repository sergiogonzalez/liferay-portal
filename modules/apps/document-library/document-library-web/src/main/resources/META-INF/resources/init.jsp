...
page import="com.liferay.document.library.web.internal.security.permission.resource.DLFileEntryCreationPermissionPolicy" %><%@
...
page import="com.liferay.document.library.web.internal.security.permission.resource.DLPermissionPolicyRenderer" %><%@
