...
@Component(
	immediate = true,
	property = "file.entry.creation.permission.policy.name=view",
	service = DLFileEntryCreationPermissionPolicy.class
)
public class InheritViewDLFileEntryCreationPermissionPolicy
	...
	public ModelPermissions getModelPermissions(long groupId, long folderId)
		...
		_addGroupDefaultModelPermissions(modelPermissions);
	...
	private void _addGroupDefaultModelPermissions(
		ModelPermissions modelPermissions) {
