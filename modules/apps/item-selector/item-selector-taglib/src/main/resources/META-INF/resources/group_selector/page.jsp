...
<div class="container-fluid-1280 lfr-item-viewer">
	...
	>
		...
		>
			...
			PortletURL viewGroupURL = itemSelector.getItemSelectorURL(requestBackedPortletURLFactory, curGroup, themeDisplay.getRefererPlid(), itemSelectedEventName, criteria.toArray(new ItemSelectorCriterion[criteria.size()]));
