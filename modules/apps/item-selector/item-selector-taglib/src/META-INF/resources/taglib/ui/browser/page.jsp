...
<div class="lfr-item-viewer" id="<%= randomNamespace %>ItemSelectorContainer">
	...
	<c:if test="<%= firstDraggableReturnType != null %>">
		<div class="drop-zone" data-returnType="<%= HtmlUtil.escapeAttribute(firstDraggableReturnType.getName()) %>" data-value="<%= firstDraggableReturnType.getValue(uploadURL) %>">
					...
					>
						...
						>
							...
							<liferay-ui:search-container-column-text name="title">
								...
								<a class="item-preview" data-returnType="<%= HtmlUtil.escapeAttribute(firstExistingFileReturnType.getName()) %>" data-url="<%= HtmlUtil.escapeAttribute(DLUtil.getPreviewURL(fileEntry, latestFileVersion, themeDisplay, StringPool.BLANK)) %>" data-value="<%= HtmlUtil.escapeAttribute(firstExistingFileReturnType.getValue(fileEntry, themeDisplay)) %>" href="<%= HtmlUtil.escapeHREF(DLUtil.getImagePreviewURL(fileEntry, themeDisplay)) %>" title="<%= HtmlUtil.escapeAttribute(title) %>">
