...
<div class="field-row">
	...
	<aui:select inlineField="<%= true %>" label="" name='<%= namespace + "preferences--chartType" + index + "--" %>' title="chart-type" useNamespace="<%= false %>" value="<%= chartType %>">
	...
	<aui:select inlineField="<%= true %>" label="" name='<%= namespace + "preferences--dataRange" + index + "--" %>' title="date-range" useNamespace="<%= false %>" value="<%= dataRange %>">
...
<div class="field-row">
	...
	<aui:select inlineField="<%= true %>" label="" name='<%= namespace + "preferences--chartWidth" + index + "--" %>' title="chart-width" useNamespace="<%= false %>">
