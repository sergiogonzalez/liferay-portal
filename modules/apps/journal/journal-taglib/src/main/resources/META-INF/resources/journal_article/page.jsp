...
<div class="journal-content-article" data-analytics-asset-id="<%= articleDisplay.getArticleId() %>" data-analytics-asset-title="<%= articleDisplay.getTitle() %>" data-analytics-asset-type="web-content" id="<portlet:namespace/>journal_content_article_<%= articleDisplay.getArticleId() %>">
	<c:if test="<%= showTitle %>">
