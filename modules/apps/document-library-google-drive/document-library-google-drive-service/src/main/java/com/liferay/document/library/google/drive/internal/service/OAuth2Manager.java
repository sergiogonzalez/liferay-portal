...
import com.liferay.document.library.google.drive.internal.configuration.GoogleDriveConfiguration;
 ...
 */
@Component(
	configurationPid = "com.liferay.document.library.google.drive.internal.configuration.GoogleDriveConfiguration",
	...
	protected void activate(Map<String, Object> properties)
		...
		GoogleDriveConfiguration googleDriveConfiguration =
			ConfigurableUtil.createConfigurable(
				GoogleDriveConfiguration.class, properties);

		// TODO: Use DB to store long lived tokens.

		_googleAuthorizationCodeFlow = new GoogleAuthorizationCodeFlow.Builder(
			GoogleNetHttpTransport.newTrustedTransport(),
			JacksonFactory.getDefaultInstance(),
			googleDriveConfiguration.clientId(),
			googleDriveConfiguration.clientSecret(),
			Collections.singleton(DriveScopes.DRIVE_FILE)
		).setDataStoreFactory(
