...
package com.liferay.document.library.google.drive.web.internal.servlet.taglib;
...
public class GoogleDriveViewJSPDynamicInclude extends BaseJSPDynamicInclude {
	...
	@Override
	@Reference(
		target = "(osgi.web.symbolicname=com.liferay.document.library.google.drive.web)",
		unbind = "-"
	)
