...
package com.liferay.document.library.google.drive.web.internal.servlet;
...
@Component(
	immediate = true,
	property = {
		"osgi.http.whiteboard.servlet.name=com.liferay.document.library.google.drive.web.internal.struts.GoogleDriveOAuth2Servlet",
		"osgi.http.whiteboard.servlet.pattern=" + GoogleDriveWebConstants.GOOGLE_DRIVE_SERVLET_PATH,
