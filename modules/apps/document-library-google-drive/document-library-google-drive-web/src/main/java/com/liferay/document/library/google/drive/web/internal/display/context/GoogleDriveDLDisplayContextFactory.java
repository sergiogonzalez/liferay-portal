...
public class GoogleDriveDLDisplayContextFactory
		...
		try {
			...
			throw new SystemException(
				StringBundler.concat(
					"Unable to build ",
					GoogleDriveDLViewFileVersionDisplayContext.class.
						getSimpleName(),
	...
	public DLViewFileVersionDisplayContext getDLViewFileVersionDisplayContext(
		...
		return new GoogleDriveDLViewFileVersionDisplayContext(
			parentDLViewFileVersionDisplayContext, request, response,
	...
	@Reference(
		target = "(bundle.symbolic.name=com.liferay.document.library.google.drive.web)"
	)
