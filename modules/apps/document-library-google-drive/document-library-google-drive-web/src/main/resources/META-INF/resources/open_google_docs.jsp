...
<%
GoogleDriveFileReference googleDriveFileReference = (GoogleDriveFileReference)request.getAttribute(GoogleDriveWebKeys.GOOGLE_DRIVE_FILE_REFERENCE);
%>
...
<html>
	...
	<body>
		...
		<portlet:actionURL name="/document_library/edit_in_google_docs" var="checkInURL">
			...
			<portlet:param name="<%= Constants.CMD %>" value="<%= GoogleDriveWebConstants.GOOGLE_DRIVE_CHECKIN %>" />
		</portlet:actionURL>
