 ...
 * @author Roberto Díaz
 */
public class KBEntriesPriorityComparator<T> extends OrderByComparator<T> {

	public static final String ORDER_BY_ASC =
		"modelFolder DESC, priority ASC, title ASC";

	public static final String ORDER_BY_DESC =
		"modelFolder DESC, priority DESC, title DESC";

	public static final String[] ORDER_BY_FIELDS = {"priority, title"};

	public KBEntriesPriorityComparator() {
		this(false);
	}

	public KBEntriesPriorityComparator(boolean ascending) {
