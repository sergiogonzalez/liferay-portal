...
page import="com.liferay.knowledge.base.util.comparator.KBArticleTitleComparator" %><%@
page import="com.liferay.knowledge.base.util.comparator.KBEntriesTitleComparator" %><%@
...
page import="com.liferay.knowledge.base.web.search.EntriesChecker" %><%@
