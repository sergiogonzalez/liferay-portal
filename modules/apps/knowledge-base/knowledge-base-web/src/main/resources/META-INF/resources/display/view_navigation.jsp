						...
						<ul>
							<li>
								...
								<c:if test="<%= childKBArticleExpanded %>">
									...
									<%
									List<KBArticle> allDescendantKBArticles = KBArticleServiceUtil.getAllDescendantKBArticles(childKBArticle.getGroupId(), childKBArticle.getResourcePrimKey(), WorkflowConstants.STATUS_APPROVED, new KBArticlePriorityComparator(true));
