...
page import="com.liferay.item.selector.ItemSelectorWebKeys" %><%@
...
page import="com.liferay.taglib.search.ResultRow" %><%@ page import="com.liferay.item.selector.ItemSelectorHelper" %>
