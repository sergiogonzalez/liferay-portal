...
public class FormNavigatorEntryConfigurationRetrieverTest {
	...
	private static FormNavigatorEntryConfigurationHandler _createMockConfig(
		...
		FormNavigatorEntryConfigurationHandler
			formNavigatorEntryConfigurationHandler =
				new FormNavigatorEntryConfigurationHandler();

		formNavigatorEntryConfigurationHandler.activate(properties);

		return formNavigatorEntryConfigurationHandler;
	}

	private static void _setMockConfigurations(
			FormNavigatorEntryConfigurationHandler... handlers)
		throws Exception {

		for (FormNavigatorEntryConfigurationHandler handler : handlers) {
			_formNavigatorEntryConfigurationRetriever.
				setFormNavigatorEntryConfigurationHandler(handler);
		}
	}
