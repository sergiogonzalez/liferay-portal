define("frontend-image-editor-capability-crop@1.0.0/CropHandles.soy", ['exports', 'metal-component/src/Component', 'metal-soy/src/Soy'], function (exports, _Component2, _Soy) {
  'use strict';
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ie_open('div', null, null, 'id', opt_data.key, 'class', 'hide', 'style', 'position: absolute; border: solid 2px #777;');
      ie_void('div', null, null, 'class', 'resize-handle', 'style', 'width: 12px; height: 12px; background-color: #777; position: absolute; bottom: -6px; right: -6px;');
      ie_close('div');
    }
