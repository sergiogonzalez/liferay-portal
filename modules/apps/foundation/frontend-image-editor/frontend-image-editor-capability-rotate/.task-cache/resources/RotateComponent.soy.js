define("frontend-image-editor-capability-rotate@1.0.0/RotateComponent.soy", ['exports', 'metal-component/src/Component', 'metal-soy/src/Soy'], function (exports, _Component2, _Soy) {
  'use strict';
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_void('a', null, null, 'class', 'btn btn-link icon-reply icon-monospaced', 'data-onclick', 'rotateLeft', 'href', 'javascript:;');
      ie_void('a', null, null, 'class', 'btn btn-link icon-share-alt icon-monospaced', 'data-onclick', 'rotateRight', 'href', 'javascript:;');
      ie_close('div');
    }
