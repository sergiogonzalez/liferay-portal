...
@Component(
	...
	property = {
		...
		"com.liferay.image.editor.tool.controls=saturation",
		"com.liferay.image.editor.tool.icon=sun",
		"com.liferay.image.editor.tool.name=Saturation",
		"com.liferay.image.editor.tool.type=tool"
	},
	service = ImageEditorFeature.class
)
public class ImageEditorSaturationFeature extends BaseImageEditorFeature {
}