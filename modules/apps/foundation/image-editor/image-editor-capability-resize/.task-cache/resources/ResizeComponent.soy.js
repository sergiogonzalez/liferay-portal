define("liferay-image-editor-capability-resize@1.0.0/ResizeComponent.soy", ['exports', 'metal-component/src/Component', 'metal-soy/src/Soy'], function (exports, _Component2, _Soy) {
    'use strict';
    ...
    goog.loadModule(function (exports) {
        ...
        function $render(opt_data, opt_ignored, opt_ijData) {
            ...
            ie_void('input', null, null, 'data-oninput', 'syncDimensions', 'id', opt_data.key + 'Width', 'type', 'number', 'value', opt_data.imageWidth);
            itext('x');
            ie_void('input', null, null, 'data-oninput', 'syncDimensions', 'id', opt_data.key + 'Height', 'type', 'number', 'value', opt_data.imageHeight);
            ie_void('button', null, null, 'class', 'btn btn-link icon-' + (opt_data.lockProportions ? 'lock' : 'unlock'), 'data-onclick', 'toggleLockProportions');
            ie_close('div');
        }
        ...
        exports.render.params = ["imageHeight", "imageWidth", "key", "lockProportions"];
        exports.render.types = { "imageHeight": "any", "imageWidth": "any", "key": "any", "lockProportions": "any" };
