...
package com.liferay.image.editor.tool.contrast;
...
@Component(
	...
	property = {
		...
		"com.liferay.image.editor.tool.controls=contrast",
		"com.liferay.image.editor.tool.icon=sun",
		"com.liferay.image.editor.tool.name=Contrast",
		"com.liferay.image.editor.tool.type=tool"
	},
	service = ImageEditorFeature.class
)
public class ImageEditorContrastFeature extends BaseImageEditorFeature {
}