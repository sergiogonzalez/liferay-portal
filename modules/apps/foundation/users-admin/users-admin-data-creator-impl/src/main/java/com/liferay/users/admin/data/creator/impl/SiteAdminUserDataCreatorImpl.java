...
import com.liferay.users.admin.data.creator.SiteAdminUserDataCreator;
 ...
 */
@Component(service = SiteAdminUserDataCreator.class)
public class SiteAdminUserDataCreatorImpl implements SiteAdminUserDataCreator {
	...
	public User create(long groupId, String emailAddress)
		...
		user = _userLocalService.addUser(
			...
			password1, password2, false, StringPool.BLANK, emailAddress,
		...
		_siteAdminUsers.add(user);

		return user;
	}

	public void delete() throws PortalException {
		for (User user : _siteAdminUsers) {
	...
	private final List<User> _siteAdminUsers = new ArrayList();
