 ...
 */
@Component(service = OmniAdminUserDataCreator.class)
public class OmniAdminUserDataCreatorImpl implements OmniAdminUserDataCreator {
	...
	public User create(long companyId, String emailAddress)
		...
		_omniAdminUsers.add(user);

		return user;
	}

	public void delete() throws PortalException {
		for (User user : _omniAdminUsers) {
	...
	private final List<User> _omniAdminUsers = new ArrayList();
