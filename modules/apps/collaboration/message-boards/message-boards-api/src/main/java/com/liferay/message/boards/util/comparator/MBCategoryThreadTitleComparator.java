 ...
 * @author David Zhang
 */
public class MBCategoryThreadTitleComparator<T> extends OrderByComparator<T> {
	...
	public MBCategoryThreadTitleComparator() {
		this(false);
	}

	public MBCategoryThreadTitleComparator(boolean ascending) {
