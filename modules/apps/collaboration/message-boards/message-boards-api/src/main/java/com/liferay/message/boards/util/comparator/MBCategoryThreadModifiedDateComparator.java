 ...
 * @author David Zhang
 */
public class MBCategoryThreadModifiedDateComparator<T>
	...
	public MBCategoryThreadModifiedDateComparator() {
		this(false);
	}

	public MBCategoryThreadModifiedDateComparator(boolean ascending) {
