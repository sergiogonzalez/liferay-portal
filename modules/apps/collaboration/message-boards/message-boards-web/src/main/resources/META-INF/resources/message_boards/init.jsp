...
page import="com.liferay.message.boards.service.permission.MBCategoryPermission" %><%@
page import="com.liferay.message.boards.service.permission.MBMessagePermission" %><%@
page import="com.liferay.message.boards.service.permission.MBPermission" %><%@
