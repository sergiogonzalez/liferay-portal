...
if (threadId > 0) {
	try {
		...
		if (Validator.isNull(subject)) {
			if (curParentMessage.getSubject().startsWith(MBMessageConstants.DEFAULT_REPLY_SUBJECT_PREFIX)) {
				subject = curParentMessage.getSubject();
			}
			else {
				subject = MBMessageConstants.DEFAULT_REPLY_SUBJECT_PREFIX + curParentMessage.getSubject();
			}
		}
