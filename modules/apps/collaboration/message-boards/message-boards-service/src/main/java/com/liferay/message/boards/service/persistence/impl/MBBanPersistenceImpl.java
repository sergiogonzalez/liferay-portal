...
import com.liferay.message.boards.exception.NoSuchMBBanException;
...
public class MBBanPersistenceImpl extends BasePersistenceImpl<MBBan>
	 ...
	 * @throws NoSuchMBBanException if a matching message boards ban could not be found
	 */
	@Override
	public MBBan findByUuid_First(String uuid,
		OrderByComparator<MBBan> orderByComparator) throws NoSuchMBBanException {
		...
		throw new NoSuchMBBanException(msg.toString());
	}
	 ...
	 * @throws NoSuchMBBanException if a message boards ban with the primary key could not be found
	 */
	@Override
	...
	/**
	 * Returns the message boards ban where uuid = &#63; and groupId = &#63; or throws a {@link NoSuchMBBanException} if it could not be found.
	 *
	 * @param uuid the uuid
	...
	/**
	 * Returns the message boards ban where groupId = &#63; and banUserId = &#63; or throws a {@link NoSuchMBBanException} if it could not be found.
	 *
	 * @param groupId the group ID
	 * @param banUserId the ban user ID
	 * @return the matching message boards ban
	 ...
	 */
	@Override
	public MBBan remove(long banId) throws NoSuchMBBanException {
	 ...
	 */
	@Override
	public MBBan remove(Serializable primaryKey) throws NoSuchMBBanException {
		Session session = null;
		...
		try {
			...
			if (mbBan == null) {
				...
				throw new NoSuchMBBanException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					primaryKey);
			}

			return remove(mbBan);
		}
		catch (NoSuchMBBanException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	/**
	 * Returns the message boards ban with the primary key or throws a {@link NoSuchMBBanException} if it could not be found.
	 *
	 * @param banId the primary key of the message boards ban
	 * @return the message boards ban
	 * @throws NoSuchMBBanException if a message boards ban with the primary key could not be found
	 */
	@Override
	public MBBan findByPrimaryKey(long banId) throws NoSuchMBBanException {
