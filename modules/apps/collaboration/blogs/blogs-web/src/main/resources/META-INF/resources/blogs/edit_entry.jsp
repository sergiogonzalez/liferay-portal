			...
			<aui:fieldset collapsed="<%= true %>" collapsible="<%= true %>" label="configuration">
				<div class="clearfix form-group">
					...
					<div class="entry-description">
						<liferay-ui:input-editor autoCreate="<%= Validator.isNull(description) ? false : true %>" contents="<%= HtmlUtil.escape(description) %>" cssClass='<%= customAbstract ? StringPool.BLANK : "readonly" %>' editorName="alloyeditor" name="descriptionEditor" onInitMethod="OnDescriptionEditorInit" placeholder="description" showSource="<%= false %>" />
					</div>
