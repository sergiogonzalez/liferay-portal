...
public interface ItemSelector {
	...
	/**
	 * Generates the item selector {@link PortletURL} according to the
	 ...
	 * @param  itemSelectorCriteria an array of the criteria for the item
	 *         selector to use to retrieve views
	 * @return the item selector {@link PortletURL}
	 */
	 ...
	 * @param  itemSelectedEventName the event name for views to fire
	 * @param  itemSelectorCriteria an array of the criteria for the item
	 *         selector to use to retrieve the views
	 * @return the item selector {@link PortletURL}
	 */
	public PortletURL getItemSelectorURL(
		RequestBackedPortletURLFactory requestBackedPortletURLFactory,
