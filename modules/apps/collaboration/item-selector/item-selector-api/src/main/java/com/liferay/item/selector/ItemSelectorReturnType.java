 ...
 * selector views to display to the user. Only the item selector views that can
 * return the item selector return type are displayed.
 * </p>
 *
 * <p>
 ...
 * return types for that view using the method {@link
