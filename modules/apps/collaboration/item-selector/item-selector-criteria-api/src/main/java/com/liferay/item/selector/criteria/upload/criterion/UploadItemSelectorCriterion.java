...
public class UploadItemSelectorCriterion extends BaseItemSelectorCriterion {
	...
	/**
	 * @deprecated As of 2.1.0, @see UploadItemSelectorCriterion{@link #UploadItemSelectorCriterion(String, String, String)}
	 */
	@Deprecated
	...
	/**
	 * @deprecated As of 2.1.0, @see UploadItemSelectorCriterion{@link #UploadItemSelectorCriterion(String, String, String, long)}
	 */
	@Deprecated
	public UploadItemSelectorCriterion(
	...
	/**
	 * @deprecated As of 2.1.0, @see UploadItemSelectorCriterion{@link #UploadItemSelectorCriterion(String, String, String, long, String[])}
	 */
	@Deprecated
	public UploadItemSelectorCriterion(
		String url, String repositoryName, long maxFileSize,
	...
	/**
	 * @deprecated As of 2.1.0, @see UploadItemSelectorCriterion{@link #setURL(String, String)}
	 */
	@Deprecated
	...
	public void setURL(String portletId, String url) {
		_portletId = portletId;
		_url = url;
	}
