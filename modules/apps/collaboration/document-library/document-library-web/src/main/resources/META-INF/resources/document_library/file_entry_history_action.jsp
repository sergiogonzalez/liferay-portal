...
DLViewFileHistoryDisplayContext dlViewFileHistoryDisplayContext = dlDisplayContextProvider.getDLViewFileHistoryDisplayContext(request, response, fileVersion);
%>
