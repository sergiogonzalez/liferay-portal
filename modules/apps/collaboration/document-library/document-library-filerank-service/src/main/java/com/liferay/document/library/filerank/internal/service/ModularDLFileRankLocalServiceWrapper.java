...
package com.liferay.document.library.filerank.internal.service;

import com.liferay.document.library.filerank.service.DLFileRankLocalService;
...
public class ModularDLFileRankLocalServiceWrapper
		...
		return ModelAdapterUtil.adapt(
			...
			_dlFileRankLocalService.addDLFileRank(
				ModelAdapterUtil.adapt(
					com.liferay.document.library.filerank.model.
						DLFileRank.class,
					dlFileRank)));
	}
	...
	public void deleteFileRank(DLFileRank dlFileRank) {
		_dlFileRankLocalService.deleteFileRank(
			ModelAdapterUtil.adapt(
				com.liferay.document.library.filerank.model.DLFileRank.class,
				dlFileRank));
	}
