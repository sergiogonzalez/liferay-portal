...
<c:if test="<%= SessionErrors.contains(renderRequest, NoSuchPageException.class.getName()) %>">
	...
	<div <%= portletTitleBasedNavigation ? "class=\"container-fluid-1280\"" : StringPool.BLANK %>>
		<div class="panel main-content-card">
			<div class="panel-body">
				...
				<div class="btn-toolbar">
					...
					<aui:button cssClass="btn-lg btn-default" onClick="<%= taglibSearch %>" value='<%= LanguageUtil.format(request, "search-for-x", HtmlUtil.escapeAttribute(title), false) %>' />
				</div>
			</div>
		</div>
	</div>
