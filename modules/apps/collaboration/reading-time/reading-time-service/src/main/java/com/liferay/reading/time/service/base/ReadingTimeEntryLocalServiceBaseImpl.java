...
public abstract class ReadingTimeEntryLocalServiceBaseImpl
	...
	public ReadingTimeEntry createReadingTimeEntry(long entryId) {
		return readingTimeEntryPersistence.create(entryId);
	}
	...
	public ReadingTimeEntry deleteReadingTimeEntry(long entryId)
		...
		return readingTimeEntryPersistence.remove(entryId);
	}
	...
	public ReadingTimeEntry fetchReadingTimeEntry(long entryId) {
		return readingTimeEntryPersistence.fetchByPrimaryKey(entryId);
	}
	...
	public ReadingTimeEntry getReadingTimeEntry(long entryId)
		throws PortalException {
		return readingTimeEntryPersistence.findByPrimaryKey(entryId);
	}
