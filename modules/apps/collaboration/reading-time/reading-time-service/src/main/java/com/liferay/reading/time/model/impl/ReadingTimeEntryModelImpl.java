...
public class ReadingTimeEntryModelImpl extends BaseModelImpl<ReadingTimeEntry>
	...
	public static final String TABLE_SQL_CREATE = "create table ReadingTimeEntry (uuid_ VARCHAR(75) null,entryId LONG not null primary key,groupId LONG,companyId LONG,createDate DATE null,modifiedDate DATE null,classNameId LONG,classPK LONG,readingTime LONG)";
	...
	*/
	...
	public Object clone() {
		...
		readingTimeEntryImpl.setEntryId(getEntryId());
	...
	public CacheModel<ReadingTimeEntry> toCacheModel() {
		...
		readingTimeEntryCacheModel.entryId = getEntryId();
