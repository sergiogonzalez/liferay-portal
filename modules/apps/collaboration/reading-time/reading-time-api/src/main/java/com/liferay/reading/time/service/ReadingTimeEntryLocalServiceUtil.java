...
public class ReadingTimeEntryLocalServiceUtil {
	...
	*/
	public static com.liferay.reading.time.model.ReadingTimeEntry createReadingTimeEntry(
		long entryId) {
		return getService().createReadingTimeEntry(entryId);
	}
	...
	*/
	public static com.liferay.reading.time.model.ReadingTimeEntry deleteReadingTimeEntry(
		long entryId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteReadingTimeEntry(entryId);
	}
	...
	*/
	...
	public static com.liferay.reading.time.model.ReadingTimeEntry fetchReadingTimeEntry(
		long entryId) {
		return getService().fetchReadingTimeEntry(entryId);
	}
	...
	*/
	public static com.liferay.reading.time.model.ReadingTimeEntry getReadingTimeEntry(
		long entryId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getReadingTimeEntry(entryId);
	}
