...
<liferay-ui:error exception="<%= RequiredStructureException.MustNotDeleteStructureLinkedToAssetVocabularies.class %>" message="the-structure-cannot-be-deleted-because-it-is-linked-to-one-or-more-asset-vocabularies" />
