...
public class WikiSettings {
	...
	public static String[] ALL_KEYS = {
		...
		"pageTitlesRemoveRegexp", "rssAbstractLength",
	};
	...
	public String getPageTitlesRemoveRegexp() {
		return _typedSettings.getValue("pageTitlesRemoveRegexp");
	}
	...
	private static FallbackKeys _getFallbackKeys() {
		...
		fallbackKeys.add("pageTitlesRemoveRegexp", "page.titles.remove.regexp");
