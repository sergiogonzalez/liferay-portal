		...
		<liferay-ui:section>
			...
			<aui:fieldset cssClass="definition-of-terms">
				...
				<dl>
					...
					<%
					Map<String, String> definitionTerms = WikiWebUtil.getEmailFromDefinitionTerms(renderRequest, wikiSettings.getEmailFromAddress(), wikiSettings.getEmailFromName());
