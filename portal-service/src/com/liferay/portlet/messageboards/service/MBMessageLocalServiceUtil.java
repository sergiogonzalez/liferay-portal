...
public class MBMessageLocalServiceUtil {
	...
	*/
	...
	public static void moveMessageAttachmentFromTrash(long userId,
		long messageId, java.lang.String deletedFileName)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService()
			.moveMessageAttachmentFromTrash(userId, messageId, deletedFileName);
	}

	public static java.lang.String moveMessageAttachmentToTrash(long userId,
