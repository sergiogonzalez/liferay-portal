...
public class DLFileVersionUtil {
	...
	* @return the matching document library file versions
	*/
	public static List<DLFileVersion> findByG_F_FN_V(long groupId,
		long folderId, java.lang.String fileName, java.lang.String version) {
		return getPersistence()
				   .findByG_F_FN_V(groupId, folderId, fileName, version);
	}
	...
	*/
	public static List<DLFileVersion> findByG_F_FN_V(long groupId,
		...
		int start, int end) {
		return getPersistence()
				   .findByG_F_FN_V(groupId, folderId, fileName, version, start,
			end);
	}
	...
	* @throws NoSuchFileVersionException if a matching document library file version could not be found
	*/
	public static DLFileVersion findByG_F_FN_V_First(long groupId,
		long folderId, java.lang.String fileName, java.lang.String version,
		OrderByComparator<DLFileVersion> orderByComparator)
		throws com.liferay.portlet.documentlibrary.NoSuchFileVersionException {
		return getPersistence()
				   .findByG_F_FN_V_First(groupId, folderId, fileName, version,
			orderByComparator);
	}
	...
	* @return the first matching document library file version, or <code>null</code> if a matching document library file version could not be found
	*/
	public static DLFileVersion fetchByG_F_FN_V_First(long groupId,
		long folderId, java.lang.String fileName, java.lang.String version,
		OrderByComparator<DLFileVersion> orderByComparator) {
		return getPersistence()
				   .fetchByG_F_FN_V_First(groupId, folderId, fileName, version,
			orderByComparator);
	}
	...
	* @throws NoSuchFileVersionException if a matching document library file version could not be found
	*/
	public static DLFileVersion findByG_F_FN_V_Last(long groupId,
		long folderId, java.lang.String fileName, java.lang.String version,
		OrderByComparator<DLFileVersion> orderByComparator)
		throws com.liferay.portlet.documentlibrary.NoSuchFileVersionException {
		return getPersistence()
				   .findByG_F_FN_V_Last(groupId, folderId, fileName, version,
			orderByComparator);
	}
	...
	* @return the last matching document library file version, or <code>null</code> if a matching document library file version could not be found
	*/
	public static DLFileVersion fetchByG_F_FN_V_Last(long groupId,
		long folderId, java.lang.String fileName, java.lang.String version,
		OrderByComparator<DLFileVersion> orderByComparator) {
		return getPersistence()
				   .fetchByG_F_FN_V_Last(groupId, folderId, fileName, version,
			orderByComparator);
	}
	...
	* @throws NoSuchFileVersionException if a document library file version with the primary key could not be found
	*/
	public static DLFileVersion[] findByG_F_FN_V_PrevAndNext(
		long fileVersionId, long groupId, long folderId,
		java.lang.String fileName, java.lang.String version,
		OrderByComparator<DLFileVersion> orderByComparator)
		throws com.liferay.portlet.documentlibrary.NoSuchFileVersionException {
		return getPersistence()
				   .findByG_F_FN_V_PrevAndNext(fileVersionId, groupId,
			folderId, fileName, version, orderByComparator);
	}
	...
	* @param version the version
	*/
	public static void removeByG_F_FN_V(long groupId, long folderId,
		java.lang.String fileName, java.lang.String version) {
		getPersistence().removeByG_F_FN_V(groupId, folderId, fileName, version);
	}
	...
	* @return the number of matching document library file versions
	*/
	public static int countByG_F_FN_V(long groupId, long folderId,
		java.lang.String fileName, java.lang.String version) {
		return getPersistence()
				   .countByG_F_FN_V(groupId, folderId, fileName, version);
	}
