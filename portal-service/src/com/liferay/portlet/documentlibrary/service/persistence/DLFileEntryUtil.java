...
public class DLFileEntryUtil {
	...
	* @return the matching document library file entries
	*/
	public static java.util.List<com.liferay.portlet.documentlibrary.model.DLFileEntry> findByC_F(
		long companyId, long fileEntryTypeId) {
		return getPersistence().findByC_F(companyId, fileEntryTypeId);
	}
	...
	*/
	public static java.util.List<com.liferay.portlet.documentlibrary.model.DLFileEntry> findByC_F(
		long companyId, long fileEntryTypeId, int start, int end) {
		return getPersistence().findByC_F(companyId, fileEntryTypeId, start, end);
	}
	...
	*/
	public static java.util.List<com.liferay.portlet.documentlibrary.model.DLFileEntry> findByC_F(
		...
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portlet.documentlibrary.model.DLFileEntry> orderByComparator) {
		return getPersistence()
				   .findByC_F(companyId, fileEntryTypeId, start, end,
			orderByComparator);
	}
	...
	* @throws com.liferay.portlet.documentlibrary.NoSuchFileEntryException if a matching document library file entry could not be found
	*/
	public static com.liferay.portlet.documentlibrary.model.DLFileEntry findByC_F_First(
		long companyId, long fileEntryTypeId,
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portlet.documentlibrary.model.DLFileEntry> orderByComparator)
		throws com.liferay.portlet.documentlibrary.NoSuchFileEntryException {
		return getPersistence()
				   .findByC_F_First(companyId, fileEntryTypeId,
			orderByComparator);
	}
	...
	* @return the first matching document library file entry, or <code>null</code> if a matching document library file entry could not be found
	*/
	public static com.liferay.portlet.documentlibrary.model.DLFileEntry fetchByC_F_First(
		long companyId, long fileEntryTypeId,
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portlet.documentlibrary.model.DLFileEntry> orderByComparator) {
		return getPersistence()
				   .fetchByC_F_First(companyId, fileEntryTypeId,
			orderByComparator);
	}
	...
	* @throws com.liferay.portlet.documentlibrary.NoSuchFileEntryException if a matching document library file entry could not be found
	*/
	public static com.liferay.portlet.documentlibrary.model.DLFileEntry findByC_F_Last(
		long companyId, long fileEntryTypeId,
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portlet.documentlibrary.model.DLFileEntry> orderByComparator)
		throws com.liferay.portlet.documentlibrary.NoSuchFileEntryException {
		return getPersistence()
				   .findByC_F_Last(companyId, fileEntryTypeId, orderByComparator);
	}
	...
	* @return the last matching document library file entry, or <code>null</code> if a matching document library file entry could not be found
	*/
	public static com.liferay.portlet.documentlibrary.model.DLFileEntry fetchByC_F_Last(
		long companyId, long fileEntryTypeId,
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portlet.documentlibrary.model.DLFileEntry> orderByComparator) {
		return getPersistence()
				   .fetchByC_F_Last(companyId, fileEntryTypeId,
			orderByComparator);
	}
	...
	* @throws com.liferay.portlet.documentlibrary.NoSuchFileEntryException if a document library file entry with the primary key could not be found
	*/
	public static com.liferay.portlet.documentlibrary.model.DLFileEntry[] findByC_F_PrevAndNext(
		long fileEntryId, long companyId, long fileEntryTypeId,
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portlet.documentlibrary.model.DLFileEntry> orderByComparator)
		throws com.liferay.portlet.documentlibrary.NoSuchFileEntryException {
		return getPersistence()
				   .findByC_F_PrevAndNext(fileEntryId, companyId,
			fileEntryTypeId, orderByComparator);
	}
	...
	* @param fileEntryTypeId the file entry type ID
	*/
	public static void removeByC_F(long companyId, long fileEntryTypeId) {
		getPersistence().removeByC_F(companyId, fileEntryTypeId);
	}
	...
	* @return the number of matching document library file entries
	*/
	public static int countByC_F(long companyId, long fileEntryTypeId) {
		return getPersistence().countByC_F(companyId, fileEntryTypeId);
	}
