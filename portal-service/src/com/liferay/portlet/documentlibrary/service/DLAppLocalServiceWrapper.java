...
public class DLAppLocalServiceWrapper implements DLAppLocalService {
	...
	*/
	...
	public java.util.List<java.lang.Object> getFoldersAndFileEntriesAndFileShortcutsByMimeTypes(
		long repositoryId, long folderId, int status,
		boolean includeMountFolders, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator obc,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _dlAppLocalService.getFoldersAndFileEntriesAndFileShortcutsByMimeTypes(repositoryId,
			folderId, status, includeMountFolders, start, end, obc, mimetypes);
	}
	...
	*/
	...
	public int getFoldersAndFileEntriesAndFileShortcutsByMimeTypesCount(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _dlAppLocalService.getFoldersAndFileEntriesAndFileShortcutsByMimeTypesCount(repositoryId,
