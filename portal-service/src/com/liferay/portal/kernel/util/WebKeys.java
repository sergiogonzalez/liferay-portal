...
public interface WebKeys {
	...
	public static final String PORTAL_MESSAGE_ANIMATION = "LIFERAY_SHARED_PORTAL_MESSAGE_ANIMATION";

	public static final String PORTAL_MESSAGE_CSS_CLASS = "LIFERAY_SHARED_PORTAL_MESSAGE_CSS_CLASS";

	public static final String PORTAL_MESSAGE_JSP_PATH = "LIFERAY_SHARED_PORTAL_MESSAGE_JSP_PATH";

	public static final String PORTAL_MESSAGE_MESSAGE = "LIFERAY_SHARED_PORTAL_MESSAGE_MESSAGE";

	public static final String PORTAL_MESSAGE_PORTLET_ID = "LIFERAY_SHARED_PORTAL_MESSAGE_PORTLET_ID";

	public static final String PORTAL_MESSAGE_TIMEOUT = "LIFERAY_SHARED_PORTAL_MESSAGE_TIMEOUT";
