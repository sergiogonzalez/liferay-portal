...
Comment rootComment = new MBCommentImpl(rootMessage);
				...
				<header class="lfr-discussion-message-author">
					...
					<c:choose>
						...
						<c:otherwise>
							...
							Comment parentComment = new MBCommentImpl(parentMessage);
							%>
							...
							<liferay-util:buffer var="parentCommentBodyBuffer">
								<a class="lfr-discussion-parent-link" data-metadata="<%= HtmlUtil.escape(parentComment.getTranslatedBody()) %>" data-title="<%= HtmlUtil.escape(parentCommentUserBuffer) %>">
