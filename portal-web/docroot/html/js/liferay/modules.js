;(function(A, Liferay) {
	...
	var createLiferayModules = function() {
		...
		var moduleList = {
			...
			'dockbar': ['aui-node', 'event-touch', 'liferay-state-convert-io', 'liferay-state-convert-node'],
			...
			'state-convert': ['liferay-state-convert-base'],
			'state-convert-base': ['aui-base'],
			'state-convert-io-base': ['liferay-state-convert-base', 'aui-io-request'],
			'state-convert-io': ['liferay-state-convert-io-base'],
			'state-convert-node': ['aui-node', 'plugin', 'liferay-state-convert-io-base'],
