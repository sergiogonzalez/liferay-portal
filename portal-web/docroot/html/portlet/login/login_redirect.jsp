						...
						success: function(event, id, obj) {
							...
							if (!exception) {
								...
								if (userStatus == 'user_added') {
									message = '<%= UnicodeLanguageUtil.format(pageContext, "thank-you-for-creating-an-account-your-password-has-been-sent-to-x", emailAddress) %>';
								}
								else if (userStatus == 'user_pending') {
									message = '<%= UnicodeLanguageUtil.format(pageContext, "thank-you-for-creating-an-account.-you-will-be-notified-via-email-at-x-when-your-account-has-been-approved", emailAddress) %>';
								}
