...
<div class="thread-controls">
	...
	<div class="thread-actions">
		<liferay-ui:icon-list>
			...
			<c:if test="<%= MBMessagePermission.contains(permissionChecker, message, ActionKeys.SUBSCRIBE) && (MBUtil.getEmailMessageAddedEnabled(portletSiteSettings) || MBUtil.getEmailMessageUpdatedEnabled(portletSiteSettings)) %>">
				<c:choose>
