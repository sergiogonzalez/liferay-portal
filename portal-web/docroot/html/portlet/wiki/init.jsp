...
long displayStyleGroupId = wikiSettings.getDisplayStyleGroupId();
boolean enableRelatedAssets = wikiSettings.isRelatedAssetsEnabled();
boolean enablePageRatings = wikiSettings.isPageRatingsEnabled();
boolean enableComments = wikiSettings.isCommentsEnabled();
boolean enableCommentRatings = wikiSettings.isCommentRatingsEnabled();
...
if (!ArrayUtil.isEmpty(visibleNodes)) {
...
boolean enableRSS = wikiSettings.isRSSEnabled();
