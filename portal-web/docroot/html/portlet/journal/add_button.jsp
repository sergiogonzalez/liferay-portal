...
boolean showAddJournalFolder = JournalFolderPermission.contains(permissionChecker, scopeGroupId, folderId, ActionKeys.ADD_FOLDER); 
boolean showAddJournalArticle = JournalFolderPermission.contains(permissionChecker, scopeGroupId, folderId, ActionKeys.ADD_ARTICLE);

if (showAddJournalArticle) {
...
<c:if test="<%= showAddJournalFolder || showAddJournalArticle %>">
	<aui:nav-item dropdown="<%= true %>" id="addButtonContainer" label="add">
		<c:if test="<%= showAddJournalFolder %>">
		...
		<c:if test="<%= showAddJournalArticle %>">
