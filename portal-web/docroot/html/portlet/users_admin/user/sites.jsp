...
>
	...
	>
		...
		<c:if test="<%= !portletName.equals(PortletKeys.MY_ACCOUNT) && !SiteMembershipPolicyUtil.isMembershipRequired(selUser.getUserId(), group.getGroupId()) && !MembershipPolicyUtil.isMembershipProtected(permissionChecker, group, selUser) %>">
			<liferay-ui:search-container-column-text>
