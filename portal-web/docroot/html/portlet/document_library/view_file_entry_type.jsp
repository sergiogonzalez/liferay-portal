...
>
	...
	>
		...
		<%
		Group fileEntryTypeGroup = GroupLocalServiceUtil.getGroup(fileEntryType.getGroupId());
		%>

		<liferay-ui:search-container-column-text
			name="scope"
			value="<%= LanguageUtil.get(pageContext, fileEntryTypeGroup.getScopeType(themeDisplay)) %>"
		/>
