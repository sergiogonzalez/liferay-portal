...
<aui:form action="<%= editFolderURL %>" method="post" name="fm" onSubmit='<%= "event.preventDefault(); " + renderResponse.getNamespace() + "savePage();" %>'>
	...
	<liferay-ui:error exception="<%= DuplicateFileException.class %>" message="the-storage-already-contains-a-folder-with-that-name.-please-enter-a-unique-folder-name" />
