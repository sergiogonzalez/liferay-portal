...
page import="com.liferay.portlet.documentlibrary.documenttype.DocumentTypeHandler" %><%@
page import="com.liferay.portlet.documentlibrary.documenttype.DocumentTypeHandlerUtil" %><%@
