	...
	<aui:fieldset>
		...
		<c:if test="<%= ((folder == null) || folder.isSupportsMetadata()) %>">
			...
			<c:if test="<%= (folder == null) || (folder.getModel() instanceof DLFolder) %>">
				...
				<%
				List<DLFileEntryType> dlFileEntryTypes = DLFileEntryTypeLocalServiceUtil.getFolderFileEntryTypes(PortalUtil.getCurrentAndAncestorSiteGroupIds(scopeGroupId), folderId, true);
				%>
