...
<OpenSearchDescription xmlns="http://a9.com/-/spec/opensearch/1.1/">
	<ShortName><%= LanguageUtil.format(pageContext, "x-search", HtmlUtil.escape(company.getName())) %></ShortName>
	<Description><%= LanguageUtil.format(pageContext, "x-search-provider", HtmlUtil.escape(company.getName())) %></Description>
