...
public class MBMessageUtil {
	...
	* @return the matching message-boards messages
	*/
	public static List<MBMessage> findByG_C_C_P(long groupId, long classNameId,
		long classPK, long parentMessageId) {
		return getPersistence()
				   .findByG_C_C_P(groupId, classNameId, classPK, parentMessageId);
	}
	...
	*/
	public static List<MBMessage> findByG_C_C_P(long groupId, long classNameId,
		...
		return getPersistence()
				   .findByG_C_C_P(groupId, classNameId, classPK,
	...
	*/
	public static List<MBMessage> findByG_C_C_P(long groupId, long classNameId,
		...
		return getPersistence()
				   .findByG_C_C_P(groupId, classNameId, classPK,
			parentMessageId, start, end, orderByComparator, retrieveFromCache);
	}
	...
	* @throws NoSuchMessageException if a matching message-boards message could not be found
	*/
	public static MBMessage findByG_C_C_P_First(long groupId, long classNameId,
		long classPK, long parentMessageId,
		OrderByComparator<MBMessage> orderByComparator)
		throws com.liferay.message.boards.kernel.exception.NoSuchMessageException {
		return getPersistence()
				   .findByG_C_C_P_First(groupId, classNameId, classPK,
	...
	* @return the first matching message-boards message, or <code>null</code> if a matching message-boards message could not be found
	*/
	public static MBMessage fetchByG_C_C_P_First(long groupId,
		long classNameId, long classPK, long parentMessageId,
		OrderByComparator<MBMessage> orderByComparator) {
		return getPersistence()
				   .fetchByG_C_C_P_First(groupId, classNameId, classPK,
			parentMessageId, orderByComparator);
	}
	...
	* @throws NoSuchMessageException if a matching message-boards message could not be found
	*/
	public static MBMessage findByG_C_C_P_Last(long groupId, long classNameId,
		long classPK, long parentMessageId,
		OrderByComparator<MBMessage> orderByComparator)
		throws com.liferay.message.boards.kernel.exception.NoSuchMessageException {
		return getPersistence()
				   .findByG_C_C_P_Last(groupId, classNameId, classPK,
			parentMessageId, orderByComparator);
	}
	...
	* @return the last matching message-boards message, or <code>null</code> if a matching message-boards message could not be found
	*/
	public static MBMessage fetchByG_C_C_P_Last(long groupId, long classNameId,
		long classPK, long parentMessageId,
		OrderByComparator<MBMessage> orderByComparator) {
		return getPersistence()
				   .fetchByG_C_C_P_Last(groupId, classNameId, classPK,
			parentMessageId, orderByComparator);
	}
	...
	* @throws NoSuchMessageException if a message-boards message with the primary key could not be found
	*/
	public static MBMessage[] findByG_C_C_P_PrevAndNext(long messageId,
		long groupId, long classNameId, long classPK, long parentMessageId,
		OrderByComparator<MBMessage> orderByComparator)
		throws com.liferay.message.boards.kernel.exception.NoSuchMessageException {
		return getPersistence()
				   .findByG_C_C_P_PrevAndNext(messageId, groupId, classNameId,
	...
	* @return the matching message-boards messages that the user has permission to view
	*/
	public static List<MBMessage> filterFindByG_C_C_P(long groupId,
		long classNameId, long classPK, long parentMessageId) {
		return getPersistence()
				   .filterFindByG_C_C_P(groupId, classNameId, classPK,
			parentMessageId);
	}
	...
	* @throws NoSuchMessageException if a message-boards message with the primary key could not be found
	*/
	public static MBMessage[] filterFindByG_C_C_P_PrevAndNext(long messageId,
		long groupId, long classNameId, long classPK, long parentMessageId,
		OrderByComparator<MBMessage> orderByComparator)
		throws com.liferay.message.boards.kernel.exception.NoSuchMessageException {
		return getPersistence()
				   .filterFindByG_C_C_P_PrevAndNext(messageId, groupId,
	...
	* @param parentMessageId the parent message ID
	*/
	public static void removeByG_C_C_P(long groupId, long classNameId,
		long classPK, long parentMessageId) {
		getPersistence()
			.removeByG_C_C_P(groupId, classNameId, classPK, parentMessageId);
	}
	...
	* @return the number of matching message-boards messages
	*/
	public static int countByG_C_C_P(long groupId, long classNameId,
		long classPK, long parentMessageId) {
		return getPersistence()
				   .countByG_C_C_P(groupId, classNameId, classPK,
			parentMessageId);
	}
	...
	* @return the number of matching message-boards messages that the user has permission to view
	*/
	public static int filterCountByG_C_C_P(long groupId, long classNameId,
		long classPK, long parentMessageId) {
		return getPersistence()
				   .filterCountByG_C_C_P(groupId, classNameId, classPK,
			parentMessageId);
	}
