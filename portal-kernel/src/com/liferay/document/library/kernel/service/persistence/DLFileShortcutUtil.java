...
public class DLFileShortcutUtil {
	...
	* @return the matching document library file shortcuts
	*/
	public static List<DLFileShortcut> findByF_A_S(long folderId,
		boolean active, int status) {
		return getPersistence().findByF_A_S(folderId, active, status);
	}
	...
	*/
	public static List<DLFileShortcut> findByF_A_S(long folderId,
		...
		return getPersistence().findByF_A_S(folderId, active, status, start, end);
	}
	...
	*/
	public static List<DLFileShortcut> findByF_A_S(long folderId,
		...
		OrderByComparator<DLFileShortcut> orderByComparator) {
		return getPersistence()
				   .findByF_A_S(folderId, active, status, start, end,
			orderByComparator);
	}
	...
	* @throws NoSuchFileShortcutException if a matching document library file shortcut could not be found
	*/
	public static DLFileShortcut findByF_A_S_First(long folderId,
		boolean active, int status,
		OrderByComparator<DLFileShortcut> orderByComparator)
		throws com.liferay.document.library.kernel.exception.NoSuchFileShortcutException {
		return getPersistence()
				   .findByF_A_S_First(folderId, active, status,
			orderByComparator);
	}
	...
	* @return the first matching document library file shortcut, or <code>null</code> if a matching document library file shortcut could not be found
	*/
	public static DLFileShortcut fetchByF_A_S_First(long folderId,
		boolean active, int status,
		OrderByComparator<DLFileShortcut> orderByComparator) {
		return getPersistence()
				   .fetchByF_A_S_First(folderId, active, status,
			orderByComparator);
	}
	...
	* @throws NoSuchFileShortcutException if a matching document library file shortcut could not be found
	*/
	public static DLFileShortcut findByF_A_S_Last(long folderId,
		boolean active, int status,
		OrderByComparator<DLFileShortcut> orderByComparator)
		throws com.liferay.document.library.kernel.exception.NoSuchFileShortcutException {
		return getPersistence()
				   .findByF_A_S_Last(folderId, active, status, orderByComparator);
	}
	...
	* @return the last matching document library file shortcut, or <code>null</code> if a matching document library file shortcut could not be found
	*/
	public static DLFileShortcut fetchByF_A_S_Last(long folderId,
		boolean active, int status,
		OrderByComparator<DLFileShortcut> orderByComparator) {
		return getPersistence()
				   .fetchByF_A_S_Last(folderId, active, status,
			orderByComparator);
	}
	...
	* @throws NoSuchFileShortcutException if a document library file shortcut with the primary key could not be found
	*/
	public static DLFileShortcut[] findByF_A_S_PrevAndNext(
		long fileShortcutId, long folderId, boolean active, int status,
		OrderByComparator<DLFileShortcut> orderByComparator)
		throws com.liferay.document.library.kernel.exception.NoSuchFileShortcutException {
		return getPersistence()
				   .findByF_A_S_PrevAndNext(fileShortcutId, folderId, active,
	...
	* @param status the status
	*/
	public static void removeByF_A_S(long folderId, boolean active, int status) {
		getPersistence().removeByF_A_S(folderId, active, status);
	}
	...
	* @return the number of matching document library file shortcuts
	*/
	public static int countByF_A_S(long folderId, boolean active, int status) {
		return getPersistence().countByF_A_S(folderId, active, status);
	}
