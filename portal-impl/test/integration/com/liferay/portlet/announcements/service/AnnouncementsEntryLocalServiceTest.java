	...
	public void testGetEntries() throws Exception {
		...
		List<AnnouncementsEntry> hiddenEntries =
			AnnouncementsEntryLocalServiceUtil.getEntries(
				group.getCompanyId(), TestPropsValues.getUserId(), scopes,
				false, AnnouncementsFlagConstants.HIDDEN, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS);
		...
		List<AnnouncementsEntry> notHiddenEntries =
			AnnouncementsEntryLocalServiceUtil.getEntries(
				group.getCompanyId(), TestPropsValues.getUserId(), scopes,
				false, AnnouncementsFlagConstants.NOT_HIDDEN, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS);
