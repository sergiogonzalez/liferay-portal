...
public class DLFolderPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		Assert.assertEquals(existingDLFolder.getMvccVersion(),
			newDLFolder.getMvccVersion());
	...
	protected OrderByComparator<DLFolder> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("DLFolder", "mvccVersion",
			true, "uuid", true, "folderId", true, "groupId", true, "companyId",
			true, "userId", true, "userName", true, "createDate", true,
			"modifiedDate", true, "repositoryId", true, "mountPoint", true,
			"parentFolderId", true, "treePath", true, "name", true,
			"description", true, "lastPostDate", true,
