...
public class DLFileEntryTypePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		Assert.assertEquals(existingDLFileEntryType.getMvccVersion(),
	...
	protected OrderByComparator<DLFileEntryType> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("DLFileEntryType",
			"mvccVersion", true, "uuid", true, "fileEntryTypeId", true,
			"groupId", true, "companyId", true, "userId", true, "userName",
			true, "createDate", true, "modifiedDate", true, "fileEntryTypeKey",
