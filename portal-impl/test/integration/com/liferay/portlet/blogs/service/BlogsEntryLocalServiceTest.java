...
public class BlogsEntryLocalServiceTest {
	...
	@Test
	public void testUrlTitleIsSavedWhenPassingURLTitleInServiceContext()
		throws Exception {
		...
		BlogsEntry entry = BlogsTestUtil.addEntryWithWorkflow(
			_user.getUserId(), RandomTestUtil.randomString(), true,
			serviceContext);

		String title = RandomTestUtil.randomString();

		String urlTitle = BlogsUtil.getUrlTitle(entry.getEntryId(), title);

		serviceContext.setAttribute("urlTitle", urlTitle);
