...
public class MBExportImportTest extends BasePortletExportImportTestCase {
	 ...
	 *
	 * It's like JournalExportImportTest (included in trunk) and
	 * WikiExportImportTest {wich not fails} and it's included in this commit
	 *
	 * I've seen that MBPortletDataHandler:doExportData has changed the way
	 * the data is exported and it's what produces this pattern of test to
	 * fail.
	 *
	 * We need a new pattern for ExportImport test when the production code
	 * changes
	 *
	 */

	//@Test
	public void testExportImportBasicMBMessage() throws Exception {
		exportImportMessage();
	...
	private void exportImportMessage() throws Exception {
