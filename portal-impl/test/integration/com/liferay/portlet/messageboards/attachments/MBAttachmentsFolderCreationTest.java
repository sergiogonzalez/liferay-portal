...
public class MBAttachmentsFolderCreationTest {
	...
	@Test
	public void testAddMBMessageCreatesFolder() throws Exception {
	...
	@Test
	public void testAddMBMessageAttachmentCreatesFolder() throws Exception {
		int expectedFolderCount =
			DLFolderLocalServiceUtil.getDLFoldersCount() + createdFolders(2);
	...
	public void testDeleteMBMessageWithAttachments() throws Exception {
		...
		Assert.assertNotSame(
			DLFolderConstants.DEFAULT_FOLDER_ID, attachmentsFolderId);
	...
	private void addMBMessage() throws Exception {
	...
	protected int createdFolders(int i) {
		return i;
	}
