...
import com.liferay.portal.security.membershippolicy.MembershipPolicyKeys;
...
public class ServiceTestUtil {
	...
	public static Group addGroup(long parentGroupId, String name)
		...
		return GroupLocalServiceUtil.addGroup(
			...
			friendlyURL, site, active, false, getServiceContext());
	}
	...
	public static int randomInt(int limit) throws Exception {
