...
public class GroupServiceTest {
	...
	public void testGroupHasCurrentPageScopeName() throws Exception {
		...
		Group group = addGroup(false, isPage, false);
	...
	public void testGroupHasCurrentSiteScopeName() throws Exception {
		...
		Group group = addGroup(isSite, false, false);
	...
	public void testGroupHasDefaultScopeName() throws Exception {
		...
		Group group = addGroup(false, false, isDefault);
	...
	protected Group addGroup(boolean isSite, boolean isPage, boolean isDefault)
		throws Exception {
