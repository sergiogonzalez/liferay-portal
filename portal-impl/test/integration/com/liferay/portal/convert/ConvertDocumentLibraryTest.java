...
public class ConvertDocumentLibraryTest {
	...
	public void testMigrateImages() throws Exception {
		...
		Assert.assertEquals(_DB_STORE_CLASSNAME, PropsValues.DL_STORE_IMPL);
	...
	private void cleanRepositories() throws Exception {
	...
	private String[] getExpectedMessages() throws Exception {
