...
public class AddDefaultDocumentLibraryStructuresAction
	...
	protected void addDLFileEntryTypes(
		...
		String[] defaultDLFileEntryTypeNames = getDefaultDLFileEntryTypeNames();

		for (int i = 0; i < defaultDLFileEntryTypeNames.length; i++) {
			addDLFileEntryTypes(
				userId, groupId, defaultDLFileEntryTypeNames[i],
	...
	private String[] getDefaultDLFileEntryTypeNames() {
		String[] defaultDLFileEntryTypeNames = {
		...
		if (UpgradeProcessUtil.isCreateIGImageDocumentType()) {
			defaultDLFileEntryTypeNames = new String[5];

			defaultDLFileEntryTypeNames = ArrayUtil.append(
				defaultDLFileEntryTypeNames,
				DLFileEntryTypeConstants.NAME_IG_IMAGE);
		}

		return defaultDLFileEntryTypeNames;
	}
