 ...
 * @author Adolfo Pérez
 */
public abstract class BaseWebUpgradeChecker {
	...
	public void activate() throws PortalException {
		...
		long oldPortletIdCount = _getPortletCount(getOldPortletIds());

		long newPortletIdCount = _getPortletCount(getNewPortletIds());
	...
	protected abstract String[] getNewPortletIds();

	protected abstract String[] getOldPortletIds();
