...
public class UpgradeDLFileEntryTypes extends UpgradeProcess {
	...
	static {
		...
		_DEFAULT_FILE_ENTRY_TYPE_MAP.put(
			DLFileEntryTypeConstants.NAME_CONTRACT, "CONTRACT");
		_DEFAULT_FILE_ENTRY_TYPE_MAP.put(
			DLFileEntryTypeConstants.NAME_MARKETING_BANNER, "MARKETING BANNER");
		_DEFAULT_FILE_ENTRY_TYPE_MAP.put(
			DLFileEntryTypeConstants.NAME_ONLINE_TRAINING, "ONLINE TRAINING");
		_DEFAULT_FILE_ENTRY_TYPE_MAP.put(
