...
public class GroupPersistenceImpl extends BasePersistenceImpl<Group>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C_S = new FinderPath(GroupModelImpl.ENTITY_CACHE_ENABLED,
			GroupModelImpl.FINDER_CACHE_ENABLED, GroupImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_C_S = new FinderPath(GroupModelImpl.ENTITY_CACHE_ENABLED,
			GroupModelImpl.FINDER_CACHE_ENABLED, GroupImpl.class,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_C_C_S = new FinderPath(GroupModelImpl.ENTITY_CACHE_ENABLED,
			GroupModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Group> findByC_C_S(long companyId, long classNameId,
		boolean site) throws SystemException {
		return findByC_C_S(companyId, classNameId, site, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<Group> findByC_C_S(long companyId, long classNameId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_C_S_SITE_2);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Group findByC_C_S_First(long companyId, long classNameId,
		boolean site, OrderByComparator orderByComparator)
		throws NoSuchGroupException, SystemException {
		Group group = fetchByC_C_S_First(companyId, classNameId, site,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Group fetchByC_C_S_First(long companyId, long classNameId,
		boolean site, OrderByComparator orderByComparator)
		throws SystemException {
		List<Group> list = findByC_C_S(companyId, classNameId, site, 0, 1,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Group findByC_C_S_Last(long companyId, long classNameId,
		boolean site, OrderByComparator orderByComparator)
		throws NoSuchGroupException, SystemException {
		Group group = fetchByC_C_S_Last(companyId, classNameId, site,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Group fetchByC_C_S_Last(long companyId, long classNameId,
		boolean site, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByC_C_S(companyId, classNameId, site);

		List<Group> list = findByC_C_S(companyId, classNameId, site, count - 1,
				count, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Group[] findByC_C_S_PrevAndNext(long groupId, long companyId,
		long classNameId, boolean site, OrderByComparator orderByComparator)
		throws NoSuchGroupException, SystemException {
		Group group = findByPrimaryKey(groupId);
		...
		try {
			...
			array[0] = getByC_C_S_PrevAndNext(session, group, companyId,
					classNameId, site, orderByComparator, true);

			array[1] = group;

			array[2] = getByC_C_S_PrevAndNext(session, group, companyId,
					classNameId, site, orderByComparator, false);
	...
	protected Group getByC_C_S_PrevAndNext(Session session, Group group,
	...
	public void removeByC_C_S(long companyId, long classNameId, boolean site)
		throws SystemException {
		for (Group group : findByC_C_S(companyId, classNameId, site)) {
			remove(group);
		}
	}
