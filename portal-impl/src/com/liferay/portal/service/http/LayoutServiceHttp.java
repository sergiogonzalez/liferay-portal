...
public class LayoutServiceHttp {
	...
	public static com.liferay.portal.model.Layout addLayout(
		...
		try {
			MethodKey methodKey = new MethodKey(LayoutServiceUtil.class,
					"addLayout", _addLayoutParameterTypes3);
	...
	public static void importPortletInfo(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(LayoutServiceUtil.class,
					"importPortletInfo", _importPortletInfoParameterTypes23);
	...
	public static void schedulePublishToLive(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(LayoutServiceUtil.class,
					...
					_schedulePublishToLiveParameterTypes25);
	...
	public static void schedulePublishToRemote(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(LayoutServiceUtil.class,
					...
					_schedulePublishToRemoteParameterTypes26);
	...
	public static void setLayouts(HttpPrincipal httpPrincipal, long groupId,
		...
		try {
			MethodKey methodKey = new MethodKey(LayoutServiceUtil.class,
					"setLayouts", _setLayoutsParameterTypes27);
	...
	public static void unschedulePublishToLive(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(LayoutServiceUtil.class,
					...
					_unschedulePublishToLiveParameterTypes28);
	...
	public static void unschedulePublishToRemote(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(LayoutServiceUtil.class,
					...
					_unschedulePublishToRemoteParameterTypes29);
	...
	public static com.liferay.portal.model.Layout updateLayout(
		...
		try {
			MethodKey methodKey = new MethodKey(LayoutServiceUtil.class,
					"updateLayout", _updateLayoutParameterTypes30);
	...
	private static final Class<?>[] _importPortletInfoParameterTypes23 = new Class[] {
			long.class, long.class, java.lang.String.class, java.util.Map.class,
			java.io.File.class
		};
	...
	private static final Class<?>[] _schedulePublishToLiveParameterTypes25 = new Class[] {
	...
	private static final Class<?>[] _schedulePublishToRemoteParameterTypes26 = new Class[] {
	...
	private static final Class<?>[] _setLayoutsParameterTypes27 = new Class[] {
			long.class, boolean.class, long.class, long[].class,
			com.liferay.portal.service.ServiceContext.class
		};
	private static final Class<?>[] _unschedulePublishToLiveParameterTypes28 = new Class[] {
			long.class, java.lang.String.class, java.lang.String.class
		};
	private static final Class<?>[] _unschedulePublishToRemoteParameterTypes29 = new Class[] {
			long.class, java.lang.String.class, java.lang.String.class
		};
	private static final Class<?>[] _updateLayoutParameterTypes30 = new Class[] {
			long.class, boolean.class, long.class, long.class,
			java.util.Map.class, java.util.Map.class, java.util.Map.class,
