...
public class TrackbackMVActionCommand extends BaseMVCActionCommand {

	public TrackbackMVActionCommand() {
		_trackback = new TrackbackImpl();
	}

	protected TrackbackMVActionCommand(Trackback trackback) {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TrackbackMVActionCommand.class);
