...
public class JournalArticlePersistenceImpl extends BasePersistenceImpl<JournalArticle>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_NOTS = new FinderPath(JournalArticleModelImpl.ENTITY_CACHE_ENABLED,
			JournalArticleModelImpl.FINDER_CACHE_ENABLED,
			JournalArticleImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByC_NotS",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_NOTS = new FinderPath(JournalArticleModelImpl.ENTITY_CACHE_ENABLED,
			JournalArticleModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<JournalArticle> findByC_NotS(long companyId, int status)
		throws SystemException {
	 ...
	 */
	@Override
	public JournalArticle findByC_NotS_First(long companyId, int status,
		OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		JournalArticle journalArticle = fetchByC_NotS_First(companyId, status,
				orderByComparator);
	 ...
	 */
	@Override
	public JournalArticle fetchByC_NotS_First(long companyId, int status,
		OrderByComparator orderByComparator) throws SystemException {
		List<JournalArticle> list = findByC_NotS(companyId, status, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public JournalArticle findByC_NotS_Last(long companyId, int status,
		OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		JournalArticle journalArticle = fetchByC_NotS_Last(companyId, status,
				orderByComparator);
	 ...
	 */
	@Override
	public JournalArticle fetchByC_NotS_Last(long companyId, int status,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<JournalArticle> list = findByC_NotS(companyId, status, count - 1,
				count, orderByComparator);
	 ...
	 */
	@Override
	public JournalArticle[] findByC_NotS_PrevAndNext(long id, long companyId,
		int status, OrderByComparator orderByComparator)
		throws NoSuchArticleException, SystemException {
		JournalArticle journalArticle = findByPrimaryKey(id);
		...
		try {
			...
			array[0] = getByC_NotS_PrevAndNext(session, journalArticle,
					companyId, status, orderByComparator, true);

			array[1] = journalArticle;

			array[2] = getByC_NotS_PrevAndNext(session, journalArticle,
	...
	protected JournalArticle getByC_NotS_PrevAndNext(Session session,
	...
	public void removeByC_NotS(long companyId, int status)
		throws SystemException {
		for (JournalArticle journalArticle : findByC_NotS(companyId, status,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(journalArticle);
		}
	}
	...
	private static final String _FINDER_COLUMN_C_NOTS_COMPANYID_2 = "journalArticle.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_NOTS_STATUS_2 = "journalArticle.status != ?";
