...
@OSGiBeanProperties(
	property = {
		...
		"render.command.name=/image_gallery_display/select_add_file_entry_type"
	},
	service = ActionCommand.class
)
public class SelectAddFileEntryTypeRenderCommand implements RenderCommand {
	...
	public String processCommand(
		...
		return
			"/html/portlet/image_gallery_display/" +
