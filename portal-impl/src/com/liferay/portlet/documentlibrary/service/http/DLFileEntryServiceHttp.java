...
public class DLFileEntryServiceHttp {
	...
	public static void checkInFileEntry(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(DLFileEntryServiceUtil.class,
					"checkInFileEntry", _checkInFileEntryParameterTypes5);
	...
	public static com.liferay.portlet.documentlibrary.model.DLFileEntry copyFileEntry(
		...
		try {
			MethodKey methodKey = new MethodKey(DLFileEntryServiceUtil.class,
					"copyFileEntry", _copyFileEntryParameterTypes10);
	...
	public static void deleteFileVersion(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(DLFileEntryServiceUtil.class,
					"deleteFileVersion", _deleteFileVersionParameterTypes13);
	...
	private static final Class<?>[] _checkInFileEntryParameterTypes5 = new Class[] {
			long.class, java.lang.String.class,
			com.liferay.portal.service.ServiceContext.class
		};
	...
	private static final Class<?>[] _copyFileEntryParameterTypes10 = new Class[] {
	...
	private static final Class<?>[] _deleteFileVersionParameterTypes13 = new Class[] {
			long.class, java.lang.String.class
		};
