...
public class DLFolderPersistenceImpl extends BasePersistenceImpl<DLFolder>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_R = new FinderPath(DLFolderModelImpl.ENTITY_CACHE_ENABLED,
			DLFolderModelImpl.FINDER_CACHE_ENABLED, DLFolderImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_R = new FinderPath(DLFolderModelImpl.ENTITY_CACHE_ENABLED,
			DLFolderModelImpl.FINDER_CACHE_ENABLED, DLFolderImpl.class,
			...
			DLFolderModelImpl.PARENTFOLDERID_COLUMN_BITMASK |
			DLFolderModelImpl.NAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_R = new FinderPath(DLFolderModelImpl.ENTITY_CACHE_ENABLED,
			DLFolderModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_R",
			new String[] { Long.class.getName(), Long.class.getName() });

	/**
	 * Returns all the document library folders where groupId = &#63; and repositoryId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param repositoryId the repository ID
	 * @return the matching document library folders
	 */
	@Override
	public List<DLFolder> findByG_R(long groupId, long repositoryId) {
		return findByG_R(groupId, repositoryId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the document library folders where groupId = &#63; and repositoryId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.documentlibrary.model.impl.DLFolderModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<DLFolder> findByG_R(long groupId, long repositoryId, int start,
		int end) {
		return findByG_R(groupId, repositoryId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the document library folders where groupId = &#63; and repositoryId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.documentlibrary.model.impl.DLFolderModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns the first document library folder in the ordered set where groupId = &#63; and repositoryId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param repositoryId the repository ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public DLFolder findByG_R_First(long groupId, long repositoryId,
		OrderByComparator<DLFolder> orderByComparator)
		throws NoSuchFolderException {
		DLFolder dlFolder = fetchByG_R_First(groupId, repositoryId,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFolder fetchByG_R_First(long groupId, long repositoryId,
		OrderByComparator<DLFolder> orderByComparator) {
		List<DLFolder> list = findByG_R(groupId, repositoryId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last document library folder in the ordered set where groupId = &#63; and repositoryId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param repositoryId the repository ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public DLFolder findByG_R_Last(long groupId, long repositoryId,
		OrderByComparator<DLFolder> orderByComparator)
		throws NoSuchFolderException {
		DLFolder dlFolder = fetchByG_R_Last(groupId, repositoryId,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFolder fetchByG_R_Last(long groupId, long repositoryId,
		OrderByComparator<DLFolder> orderByComparator) {
		...
		List<DLFolder> list = findByG_R(groupId, repositoryId, count - 1,
				count, orderByComparator);
	...
	/**
	 * Returns the document library folders before and after the current document library folder in the ordered set where groupId = &#63; and repositoryId = &#63;.
	 *
	 * @param folderId the primary key of the current document library folder
	 * @param groupId the group ID
	 * @param repositoryId the repository ID
	 ...
	 */
	@Override
	public DLFolder[] findByG_R_PrevAndNext(long folderId, long groupId,
		...
		try {
			...
			array[0] = getByG_R_PrevAndNext(session, dlFolder, groupId,
					repositoryId, orderByComparator, true);

			array[1] = dlFolder;

			array[2] = getByG_R_PrevAndNext(session, dlFolder, groupId,
	...
	protected DLFolder getByG_R_PrevAndNext(Session session, DLFolder dlFolder,
	...
	/**
	 * Returns all the document library folders that the user has permission to view where groupId = &#63; and repositoryId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param repositoryId the repository ID
	 * @return the matching document library folders that the user has permission to view
	 */
	@Override
	public List<DLFolder> filterFindByG_R(long groupId, long repositoryId) {
		return filterFindByG_R(groupId, repositoryId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the document library folders that the user has permission to view where groupId = &#63; and repositoryId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.documentlibrary.model.impl.DLFolderModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the document library folders that the user has permissions to view where groupId = &#63; and repositoryId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.documentlibrary.model.impl.DLFolderModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns the document library folders before and after the current document library folder in the ordered set of document library folders that the user has permission to view where groupId = &#63; and repositoryId = &#63;.
	 *
	 * @param folderId the primary key of the current document library folder
	 * @param groupId the group ID
	 * @param repositoryId the repository ID
	 ...
	 */
	@Override
	public DLFolder[] filterFindByG_R_PrevAndNext(long folderId, long groupId,
		long repositoryId, OrderByComparator<DLFolder> orderByComparator)
		throws NoSuchFolderException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_R_PrevAndNext(folderId, groupId, repositoryId,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_R_PrevAndNext(session, dlFolder, groupId,
					repositoryId, orderByComparator, true);

			array[1] = dlFolder;

			array[2] = filterGetByG_R_PrevAndNext(session, dlFolder, groupId,
					repositoryId, orderByComparator, false);
	...
	protected DLFolder filterGetByG_R_PrevAndNext(Session session,
		DLFolder dlFolder, long groupId, long repositoryId,
		OrderByComparator<DLFolder> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the document library folders where groupId = &#63; and repositoryId = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param repositoryId the repository ID
	 */
	...
	public void removeByG_R(long groupId, long repositoryId) {
		for (DLFolder dlFolder : findByG_R(groupId, repositoryId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(dlFolder);
		}
	}
	...
	/**
	 * Returns the number of document library folders where groupId = &#63; and repositoryId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param repositoryId the repository ID
	 * @return the number of matching document library folders
	...
	/**
	 * Returns the number of document library folders that the user has permission to view where groupId = &#63; and repositoryId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param repositoryId the repository ID
	 * @return the number of matching document library folders that the user has permission to view
	...
	private static final String _FINDER_COLUMN_G_R_GROUPID_2 = "dlFolder.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_R_REPOSITORYID_2 = "dlFolder.repositoryId = ?";
