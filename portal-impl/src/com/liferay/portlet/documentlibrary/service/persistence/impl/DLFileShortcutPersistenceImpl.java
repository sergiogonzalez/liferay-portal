...
public class DLFileShortcutPersistenceImpl extends BasePersistenceImpl<DLFileShortcut>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_A_S = new FinderPath(DLFileShortcutModelImpl.ENTITY_CACHE_ENABLED,
			DLFileShortcutModelImpl.FINDER_CACHE_ENABLED,
			DLFileShortcutImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByF_A_S",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_A_S = new FinderPath(DLFileShortcutModelImpl.ENTITY_CACHE_ENABLED,
			DLFileShortcutModelImpl.FINDER_CACHE_ENABLED,
			DLFileShortcutImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByF_A_S",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Integer.class.getName()
			},
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_F_A_S = new FinderPath(DLFileShortcutModelImpl.ENTITY_CACHE_ENABLED,
			DLFileShortcutModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByF_A_S",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Integer.class.getName()
			});
	 ...
	 */
	@Override
	public List<DLFileShortcut> findByF_A_S(long folderId, boolean active,
		int status) {
		return findByF_A_S(folderId, active, status, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<DLFileShortcut> findByF_A_S(long folderId, boolean active,
		...
		return findByF_A_S(folderId, active, status, start, end, null);
	}
	...
	public List<DLFileShortcut> findByF_A_S(long folderId, boolean active,
		int status, int start, int end,
		OrderByComparator<DLFileShortcut> orderByComparator) {
		return findByF_A_S(folderId, active, status, start, end,
			orderByComparator, true);
	}
	...
	public List<DLFileShortcut> findByF_A_S(long folderId, boolean active,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_A_S;
			finderArgs = new Object[] { folderId, active, status };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_A_S;
			finderArgs = new Object[] {
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (DLFileShortcut dlFileShortcut : list) {
					if ((folderId != dlFileShortcut.getFolderId()) ||
							(active != dlFileShortcut.getActive()) ||
							(status != dlFileShortcut.getStatus())) {
						list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_F_A_S_FOLDERID_2);

			query.append(_FINDER_COLUMN_F_A_S_ACTIVE_2);

			query.append(_FINDER_COLUMN_F_A_S_STATUS_2);
	...
	public DLFileShortcut findByF_A_S_First(long folderId, boolean active,
		...
		throws NoSuchFileShortcutException {
		DLFileShortcut dlFileShortcut = fetchByF_A_S_First(folderId, active,
	...
	public DLFileShortcut fetchByF_A_S_First(long folderId, boolean active,
		int status, OrderByComparator<DLFileShortcut> orderByComparator) {
		List<DLFileShortcut> list = findByF_A_S(folderId, active, status, 0, 1,
				orderByComparator);
	...
	public DLFileShortcut findByF_A_S_Last(long folderId, boolean active,
		int status, OrderByComparator<DLFileShortcut> orderByComparator)
		throws NoSuchFileShortcutException {
		DLFileShortcut dlFileShortcut = fetchByF_A_S_Last(folderId, active,
				status, orderByComparator);
	...
	public DLFileShortcut fetchByF_A_S_Last(long folderId, boolean active,
		int status, OrderByComparator<DLFileShortcut> orderByComparator) {
		int count = countByF_A_S(folderId, active, status);

		if (count == 0) {
			return null;
		}

		List<DLFileShortcut> list = findByF_A_S(folderId, active, status,
				count - 1, count, orderByComparator);
	...
	public DLFileShortcut[] findByF_A_S_PrevAndNext(long fileShortcutId,
		...
		try {
			...
			array[0] = getByF_A_S_PrevAndNext(session, dlFileShortcut,
					folderId, active, status, orderByComparator, true);

			array[1] = dlFileShortcut;

			array[2] = getByF_A_S_PrevAndNext(session, dlFileShortcut,
					folderId, active, status, orderByComparator, false);
	...
	protected DLFileShortcut getByF_A_S_PrevAndNext(Session session,
		DLFileShortcut dlFileShortcut, long folderId, boolean active,
		int status, OrderByComparator<DLFileShortcut> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByF_A_S(long folderId, boolean active, int status) {
		for (DLFileShortcut dlFileShortcut : findByF_A_S(folderId, active,
	...
	public int countByF_A_S(long folderId, boolean active, int status) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_F_A_S;

		Object[] finderArgs = new Object[] { folderId, active, status };
	...
	private static final String _FINDER_COLUMN_F_A_S_FOLDERID_2 = "dlFileShortcut.folderId = ? AND ";
	private static final String _FINDER_COLUMN_F_A_S_ACTIVE_2 = "dlFileShortcut.active = ? AND ";
	private static final String _FINDER_COLUMN_F_A_S_STATUS_2 = "dlFileShortcut.status = ?";
	...
	public DLFileShortcut updateImpl(DLFileShortcut dlFileShortcut) {
		...
		if (isNew || !DLFileShortcutModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((dlFileShortcutModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_A_S.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						dlFileShortcutModelImpl.getOriginalFolderId(),
						dlFileShortcutModelImpl.getOriginalActive(),
				...
				finderCache.removeResult(FINDER_PATH_COUNT_BY_F_A_S, args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_A_S,
					args);
