...
public class DLFileShortcutPersistenceImpl extends BasePersistenceImpl<DLFileShortcut>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPID = new FinderPath(DLFileShortcutModelImpl.ENTITY_CACHE_ENABLED,
			DLFileShortcutModelImpl.FINDER_CACHE_ENABLED,
			DLFileShortcutImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByGroupId",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_GROUPID =
		new FinderPath(DLFileShortcutModelImpl.ENTITY_CACHE_ENABLED,
			...
			DLFileShortcutModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPID = new FinderPath(DLFileShortcutModelImpl.ENTITY_CACHE_ENABLED,
			DLFileShortcutModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<DLFileShortcut> findByGroupId(long groupId, int start, int end) {
	 ...
	 */
	@Override
	public DLFileShortcut findByGroupId_First(long groupId,
		OrderByComparator<DLFileShortcut> orderByComparator)
		throws NoSuchFileShortcutException {
		DLFileShortcut dlFileShortcut = fetchByGroupId_First(groupId,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFileShortcut fetchByGroupId_First(long groupId,
		OrderByComparator<DLFileShortcut> orderByComparator) {
		List<DLFileShortcut> list = findByGroupId(groupId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFileShortcut findByGroupId_Last(long groupId,
		OrderByComparator<DLFileShortcut> orderByComparator)
		throws NoSuchFileShortcutException {
		DLFileShortcut dlFileShortcut = fetchByGroupId_Last(groupId,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFileShortcut fetchByGroupId_Last(long groupId,
		OrderByComparator<DLFileShortcut> orderByComparator) {
		...
		List<DLFileShortcut> list = findByGroupId(groupId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFileShortcut[] findByGroupId_PrevAndNext(long fileShortcutId,
		...
		try {
			...
			array[0] = getByGroupId_PrevAndNext(session, dlFileShortcut,
					groupId, orderByComparator, true);

			array[1] = dlFileShortcut;

			array[2] = getByGroupId_PrevAndNext(session, dlFileShortcut,
	...
	protected DLFileShortcut getByGroupId_PrevAndNext(Session session,
		DLFileShortcut dlFileShortcut, long groupId,
		OrderByComparator<DLFileShortcut> orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public List<DLFileShortcut> filterFindByGroupId(long groupId, int start,
		int end) {
	...
	public DLFileShortcut[] filterFindByGroupId_PrevAndNext(
		...
		throws NoSuchFileShortcutException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByGroupId_PrevAndNext(fileShortcutId, groupId,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByGroupId_PrevAndNext(session, dlFileShortcut,
					groupId, orderByComparator, true);

			array[1] = dlFileShortcut;

			array[2] = filterGetByGroupId_PrevAndNext(session, dlFileShortcut,
					groupId, orderByComparator, false);
	...
	protected DLFileShortcut filterGetByGroupId_PrevAndNext(Session session,
		DLFileShortcut dlFileShortcut, long groupId,
		OrderByComparator<DLFileShortcut> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByGroupId(long groupId) {
		for (DLFileShortcut dlFileShortcut : findByGroupId(groupId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(dlFileShortcut);
		}
	}
	...
	private static final String _FINDER_COLUMN_GROUPID_GROUPID_2 = "dlFileShortcut.groupId = ?";
	...
	public DLFileShortcut updateImpl(DLFileShortcut dlFileShortcut) {
		...
		if (!DLFileShortcutModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] { dlFileShortcutModelImpl.getGroupId() };
