...
public class DLFileEntryPersistenceImpl extends BasePersistenceImpl<DLFileEntry>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_R = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
			DLFileEntryModelImpl.FINDER_CACHE_ENABLED, DLFileEntryImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_R = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
			DLFileEntryModelImpl.FINDER_CACHE_ENABLED, DLFileEntryImpl.class,
			...
			DLFileEntryModelImpl.FOLDERID_COLUMN_BITMASK |
			DLFileEntryModelImpl.NAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_R = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
			DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_R",
			new String[] { Long.class.getName(), Long.class.getName() });

	/**
	 * Returns all the document library file entries where groupId = &#63; and repositoryId = &#63;.
	 *
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public List<DLFileEntry> findByG_R(long groupId, long repositoryId) {
		return findByG_R(groupId, repositoryId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the document library file entries where groupId = &#63; and repositoryId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.documentlibrary.model.impl.DLFileEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<DLFileEntry> findByG_R(long groupId, long repositoryId,
		int start, int end) {
		return findByG_R(groupId, repositoryId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the document library file entries where groupId = &#63; and repositoryId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.documentlibrary.model.impl.DLFileEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<DLFileEntry> findByG_R(long groupId, long repositoryId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderArgs = new Object[] { groupId, repositoryId };
		}
		else {
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_R_REPOSITORYID_2);
	...
	/**
	 * Returns the first document library file entry in the ordered set where groupId = &#63; and repositoryId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param repositoryId the repository ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public DLFileEntry findByG_R_First(long groupId, long repositoryId,
		OrderByComparator<DLFileEntry> orderByComparator)
		throws NoSuchFileEntryException {
		DLFileEntry dlFileEntry = fetchByG_R_First(groupId, repositoryId,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFileEntry fetchByG_R_First(long groupId, long repositoryId,
		OrderByComparator<DLFileEntry> orderByComparator) {
		List<DLFileEntry> list = findByG_R(groupId, repositoryId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last document library file entry in the ordered set where groupId = &#63; and repositoryId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param repositoryId the repository ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public DLFileEntry findByG_R_Last(long groupId, long repositoryId,
		OrderByComparator<DLFileEntry> orderByComparator)
		throws NoSuchFileEntryException {
		DLFileEntry dlFileEntry = fetchByG_R_Last(groupId, repositoryId,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFileEntry fetchByG_R_Last(long groupId, long repositoryId,
		OrderByComparator<DLFileEntry> orderByComparator) {
		int count = countByG_R(groupId, repositoryId);

		if (count == 0) {
			return null;
		}

		List<DLFileEntry> list = findByG_R(groupId, repositoryId, count - 1,
				count, orderByComparator);
	...
	/**
	 * Returns the document library file entries before and after the current document library file entry in the ordered set where groupId = &#63; and repositoryId = &#63;.
	 *
	 * @param fileEntryId the primary key of the current document library file entry
	 * @param groupId the group ID
	 * @param repositoryId the repository ID
	 ...
	 */
	@Override
	public DLFileEntry[] findByG_R_PrevAndNext(long fileEntryId, long groupId,
		...
		try {
			...
			array[0] = getByG_R_PrevAndNext(session, dlFileEntry, groupId,
					repositoryId, orderByComparator, true);

			array[1] = dlFileEntry;

			array[2] = getByG_R_PrevAndNext(session, dlFileEntry, groupId,
	...
	protected DLFileEntry getByG_R_PrevAndNext(Session session,
		DLFileEntry dlFileEntry, long groupId, long repositoryId,
		OrderByComparator<DLFileEntry> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Returns all the document library file entries that the user has permission to view where groupId = &#63; and repositoryId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param repositoryId the repository ID
	 * @return the matching document library file entries that the user has permission to view
	 */
	@Override
	public List<DLFileEntry> filterFindByG_R(long groupId, long repositoryId) {
		return filterFindByG_R(groupId, repositoryId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the document library file entries that the user has permission to view where groupId = &#63; and repositoryId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.documentlibrary.model.impl.DLFileEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<DLFileEntry> filterFindByG_R(long groupId, long repositoryId,
		int start, int end) {
		return filterFindByG_R(groupId, repositoryId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the document library file entries that the user has permissions to view where groupId = &#63; and repositoryId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.documentlibrary.model.impl.DLFileEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<DLFileEntry> filterFindByG_R(long groupId, long repositoryId,
		int start, int end, OrderByComparator<DLFileEntry> orderByComparator) {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_R(groupId, repositoryId, start, end,
				orderByComparator);
		}
	...
	/**
	 * Returns the document library file entries before and after the current document library file entry in the ordered set of document library file entries that the user has permission to view where groupId = &#63; and repositoryId = &#63;.
	 *
	 * @param fileEntryId the primary key of the current document library file entry
	 * @param groupId the group ID
	 * @param repositoryId the repository ID
	 ...
	 */
	@Override
	public DLFileEntry[] filterFindByG_R_PrevAndNext(long fileEntryId,
		long groupId, long repositoryId,
		OrderByComparator<DLFileEntry> orderByComparator)
		throws NoSuchFileEntryException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_R_PrevAndNext(fileEntryId, groupId, repositoryId,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_R_PrevAndNext(session, dlFileEntry,
					groupId, repositoryId, orderByComparator, true);

			array[1] = dlFileEntry;

			array[2] = filterGetByG_R_PrevAndNext(session, dlFileEntry,
					groupId, repositoryId, orderByComparator, false);
	...
	protected DLFileEntry filterGetByG_R_PrevAndNext(Session session,
		DLFileEntry dlFileEntry, long groupId, long repositoryId,
		OrderByComparator<DLFileEntry> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the document library file entries where groupId = &#63; and repositoryId = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param repositoryId the repository ID
	 */
	@Override
	public void removeByG_R(long groupId, long repositoryId) {
		for (DLFileEntry dlFileEntry : findByG_R(groupId, repositoryId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(dlFileEntry);
		}
	}
	...
	/**
	 * Returns the number of document library file entries where groupId = &#63; and repositoryId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param repositoryId the repository ID
	 * @return the number of matching document library file entries
	 */
	@Override
	public int countByG_R(long groupId, long repositoryId) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_G_R;

		Object[] finderArgs = new Object[] { groupId, repositoryId };
	...
	/**
	 * Returns the number of document library file entries that the user has permission to view where groupId = &#63; and repositoryId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param repositoryId the repository ID
	 * @return the number of matching document library file entries that the user has permission to view
	 */
	@Override
	public int filterCountByG_R(long groupId, long repositoryId) {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_R(groupId, repositoryId);
		}
	...
	private static final String _FINDER_COLUMN_G_R_GROUPID_2 = "dlFileEntry.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_R_REPOSITORYID_2 = "dlFileEntry.repositoryId = ?";
