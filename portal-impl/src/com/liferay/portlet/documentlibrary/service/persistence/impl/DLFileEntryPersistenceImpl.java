...
public class DLFileEntryPersistenceImpl extends BasePersistenceImpl<DLFileEntry>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_F = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
			DLFileEntryModelImpl.FINDER_CACHE_ENABLED, DLFileEntryImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_F = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
			DLFileEntryModelImpl.FINDER_CACHE_ENABLED, DLFileEntryImpl.class,
			...
			DLFileEntryModelImpl.FOLDERID_COLUMN_BITMASK |
			DLFileEntryModelImpl.NAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_F = new FinderPath(DLFileEntryModelImpl.ENTITY_CACHE_ENABLED,
			DLFileEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_F",
			new String[] { Long.class.getName(), Long.class.getName() });

	/**
	 * Returns all the document library file entries where companyId = &#63; and fileEntryTypeId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param fileEntryTypeId the file entry type ID
	 * @return the matching document library file entries
	 */
	@Override
	public List<DLFileEntry> findByC_F(long companyId, long fileEntryTypeId) {
		return findByC_F(companyId, fileEntryTypeId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the document library file entries where companyId = &#63; and fileEntryTypeId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.documentlibrary.model.impl.DLFileEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<DLFileEntry> findByC_F(long companyId, long fileEntryTypeId,
		int start, int end) {
		return findByC_F(companyId, fileEntryTypeId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the document library file entries where companyId = &#63; and fileEntryTypeId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.documentlibrary.model.impl.DLFileEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<DLFileEntry> findByC_F(long companyId, long fileEntryTypeId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderArgs = new Object[] { companyId, fileEntryTypeId };
		}
		else {
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_F_FILEENTRYTYPEID_2);
	...
	/**
	 * Returns the first document library file entry in the ordered set where companyId = &#63; and fileEntryTypeId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param fileEntryTypeId the file entry type ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public DLFileEntry findByC_F_First(long companyId, long fileEntryTypeId,
		OrderByComparator<DLFileEntry> orderByComparator)
		throws NoSuchFileEntryException {
		DLFileEntry dlFileEntry = fetchByC_F_First(companyId, fileEntryTypeId,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFileEntry fetchByC_F_First(long companyId, long fileEntryTypeId,
		OrderByComparator<DLFileEntry> orderByComparator) {
		List<DLFileEntry> list = findByC_F(companyId, fileEntryTypeId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last document library file entry in the ordered set where companyId = &#63; and fileEntryTypeId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param fileEntryTypeId the file entry type ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public DLFileEntry findByC_F_Last(long companyId, long fileEntryTypeId,
		OrderByComparator<DLFileEntry> orderByComparator)
		throws NoSuchFileEntryException {
		DLFileEntry dlFileEntry = fetchByC_F_Last(companyId, fileEntryTypeId,
				orderByComparator);
	 ...
	 */
	@Override
	public DLFileEntry fetchByC_F_Last(long companyId, long fileEntryTypeId,
		OrderByComparator<DLFileEntry> orderByComparator) {
		int count = countByC_F(companyId, fileEntryTypeId);

		if (count == 0) {
			return null;
		}

		List<DLFileEntry> list = findByC_F(companyId, fileEntryTypeId,
				count - 1, count, orderByComparator);
	...
	/**
	 * Returns the document library file entries before and after the current document library file entry in the ordered set where companyId = &#63; and fileEntryTypeId = &#63;.
	 *
	 * @param fileEntryId the primary key of the current document library file entry
	 * @param companyId the company ID
	 * @param fileEntryTypeId the file entry type ID
	 ...
	 */
	@Override
	public DLFileEntry[] findByC_F_PrevAndNext(long fileEntryId,
		...
		try {
			...
			array[0] = getByC_F_PrevAndNext(session, dlFileEntry, companyId,
					fileEntryTypeId, orderByComparator, true);

			array[1] = dlFileEntry;

			array[2] = getByC_F_PrevAndNext(session, dlFileEntry, companyId,
					fileEntryTypeId, orderByComparator, false);
	...
	protected DLFileEntry getByC_F_PrevAndNext(Session session,
		DLFileEntry dlFileEntry, long companyId, long fileEntryTypeId,
		OrderByComparator<DLFileEntry> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the document library file entries where companyId = &#63; and fileEntryTypeId = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @param fileEntryTypeId the file entry type ID
	 */
	@Override
	public void removeByC_F(long companyId, long fileEntryTypeId) {
		for (DLFileEntry dlFileEntry : findByC_F(companyId, fileEntryTypeId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(dlFileEntry);
		}
	}
	...
	/**
	 * Returns the number of document library file entries where companyId = &#63; and fileEntryTypeId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param fileEntryTypeId the file entry type ID
	 * @return the number of matching document library file entries
	 */
	@Override
	public int countByC_F(long companyId, long fileEntryTypeId) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_C_F;

		Object[] finderArgs = new Object[] { companyId, fileEntryTypeId };
	...
	private static final String _FINDER_COLUMN_C_F_COMPANYID_2 = "dlFileEntry.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_F_FILEENTRYTYPEID_2 = "dlFileEntry.fileEntryTypeId = ?";
