 ...
 * @author Ivica Cardic
 */
public class ImageMagickImpl2  {

	public static ImageMagickImpl2 getInstance() {
		return _instance;
	}
	...
	public Future<?> convert(List<String> arguments) throws Exception {
		...
		LiferayConvertCmd2 liferayConvertCmd = new LiferayConvertCmd2();
	...
	public String[] identify(List<String> arguments) throws Exception {
		...
		LiferayIdentifyCmd2 liferayIdentifyCmd = new LiferayIdentifyCmd2();
			...
			if (_processExecutor == null) {
				...
				_processExecutor.setThreadFactory(
					new NamedThreadFactory(
						ImageMagickImpl2.class.getName(), Thread.MIN_PRIORITY,
	...
	public class LiferayConvertCmd2 extends ConvertCmd {
		...
		public ProcessTask getProcessTask(
			...
			arguments.addAll(_instanceConvertCmd.getCommand());
	...
	public class LiferayIdentifyCmd2 extends IdentifyCmd {
		...
		public ProcessTask getProcessTask(
			...
			arguments.addAll(_instanceIdentifyCmd.getCommand());
			arguments.addAll(resourceLimits);
			arguments.addAll(commandArguments);
	...
	private static Log _log = LogFactoryUtil.getLog(ImageMagickImpl2.class);

	private static ImageMagickImpl2 _instance = new ImageMagickImpl2();
	...
	private static LiferayConvertCmd2 _instanceConvertCmd = _instance.new LiferayConvertCmd2();
	private static LiferayIdentifyCmd2 _instanceIdentifyCmd = _instance.new LiferayIdentifyCmd2();
