...
@OSGiBeanProperties(
	property = {
		...
		"mvc.command.name=/document_library/select_group"
	},
	service = MVCRenderCommand.class
)
public class SelectGroupMVCRenderCommand extends BaseJSPMVCRenderCommand {

	public SelectGroupMVCRenderCommand() {
		super("/html/portlet/document_library/select_group.jsp");
	}
