...
@OSGiBeanProperties(
	property = {
		...
		"mvc.command.name=/document_library/view_file_entry_type"
	},
	service = MVCRenderCommand.class
)
public class ViewFileEntryTypeMVCRenderCommand extends BaseJSPMVCRenderCommand {

	public ViewFileEntryTypeMVCRenderCommand() {
		super("/html/portlet/document_library/view_file_entry_type.jsp");
	}
