...
@OSGiBeanProperties(
	property = {
		...
		"mvc.command.name=/document_library/select_restricted_file_entry_type"
	},
	service = MVCRenderCommand.class
)
public class SelectRestrictedFileEntryTypeMVCRenderCommand
	extends BaseJSPMVCRenderCommand {

	public SelectRestrictedFileEntryTypeMVCRenderCommand() {
		super(
