...
public class MBCategoryPersistenceImpl extends BasePersistenceImpl<MBCategory>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_NOTC_P = new FinderPath(MBCategoryModelImpl.ENTITY_CACHE_ENABLED,
			MBCategoryModelImpl.FINDER_CACHE_ENABLED, MBCategoryImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_NotC_P",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_NOTC_P =
		new FinderPath(MBCategoryModelImpl.ENTITY_CACHE_ENABLED,
			MBCategoryModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByG_NotC_P",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			});

	/**
	 * Returns all the message boards categories where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63;.
	 *
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public List<MBCategory> findByG_NotC_P(long groupId, long categoryId,
		long parentCategoryId) throws SystemException {
		return findByG_NotC_P(groupId, categoryId, parentCategoryId,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the message boards categories where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.messageboards.model.impl.MBCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<MBCategory> findByG_NotC_P(long groupId, long categoryId,
		long parentCategoryId, int start, int end) throws SystemException {
		return findByG_NotC_P(groupId, categoryId, parentCategoryId, start,
			end, null);
	}

	/**
	 * Returns an ordered range of all the message boards categories where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.messageboards.model.impl.MBCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<MBCategory> findByG_NotC_P(long groupId, long categoryId,
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_G_NOTC_P;
		finderArgs = new Object[] {
				groupId, categoryId, parentCategoryId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_NOTC_P_GROUPID_2);

			query.append(_FINDER_COLUMN_G_NOTC_P_CATEGORYID_2);

			query.append(_FINDER_COLUMN_G_NOTC_P_PARENTCATEGORYID_2);
	...
	/**
	 * Returns the first message boards category in the ordered set where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param categoryId the category ID
	 * @param parentCategoryId the parent category ID
	 ...
	 */
	@Override
	public MBCategory findByG_NotC_P_First(long groupId, long categoryId,
		long parentCategoryId, OrderByComparator orderByComparator)
		throws NoSuchCategoryException, SystemException {
		MBCategory mbCategory = fetchByG_NotC_P_First(groupId, categoryId,
	 ...
	 */
	@Override
	public MBCategory fetchByG_NotC_P_First(long groupId, long categoryId,
		long parentCategoryId, OrderByComparator orderByComparator)
		throws SystemException {
		List<MBCategory> list = findByG_NotC_P(groupId, categoryId,
	...
	/**
	 * Returns the last message boards category in the ordered set where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param categoryId the category ID
	 * @param parentCategoryId the parent category ID
	 ...
	 */
	@Override
	public MBCategory findByG_NotC_P_Last(long groupId, long categoryId,
		long parentCategoryId, OrderByComparator orderByComparator)
		throws NoSuchCategoryException, SystemException {
		MBCategory mbCategory = fetchByG_NotC_P_Last(groupId, categoryId,
				parentCategoryId, orderByComparator);
	 ...
	 */
	@Override
	public MBCategory fetchByG_NotC_P_Last(long groupId, long categoryId,
		long parentCategoryId, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByG_NotC_P(groupId, categoryId, parentCategoryId);
	...
	/**
	 * Returns all the message boards categories that the user has permission to view where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param categoryId the category ID
	 * @param parentCategoryId the parent category ID
	 ...
	 */
	@Override
	public List<MBCategory> filterFindByG_NotC_P(long groupId, long categoryId,
		long parentCategoryId) throws SystemException {
		return filterFindByG_NotC_P(groupId, categoryId, parentCategoryId,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the message boards categories that the user has permission to view where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.messageboards.model.impl.MBCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the message boards categories that the user has permissions to view where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.messageboards.model.impl.MBCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns all the message boards categories that the user has permission to view where groupId = &#63; and categoryId &ne; any &#63; and parentCategoryId = any &#63;.
	 *
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public List<MBCategory> filterFindByG_NotC_P(long groupId,
		long[] categoryIds, long[] parentCategoryIds) throws SystemException {
		return filterFindByG_NotC_P(groupId, categoryIds, parentCategoryIds,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the message boards categories that the user has permission to view where groupId = &#63; and categoryId &ne; any &#63; and parentCategoryId = any &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.messageboards.model.impl.MBCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	@Override
	public List<MBCategory> filterFindByG_NotC_P(long groupId,
		long[] categoryIds, long[] parentCategoryIds, int start, int end)
		throws SystemException {
		return filterFindByG_NotC_P(groupId, categoryIds, parentCategoryIds,
			start, end, null);
	}
	...
	/**
	 * Returns an ordered range of all the message boards categories that the user has permission to view where groupId = &#63; and categoryId &ne; any &#63; and parentCategoryId = any &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.messageboards.model.impl.MBCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<MBCategory> filterFindByG_NotC_P(long groupId,
		...
		OrderByComparator orderByComparator) throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_NotC_P(groupId, categoryIds, parentCategoryIds,
				start, end, orderByComparator);
		}
		...
		query.append(_FINDER_COLUMN_G_NOTC_P_GROUPID_5);
		...
		if ((categoryIds == null) || (categoryIds.length > 0)) {
			...
			for (int i = 0; i < categoryIds.length; i++) {
				query.append(_FINDER_COLUMN_G_NOTC_P_CATEGORYID_5);
		...
		if ((parentCategoryIds == null) || (parentCategoryIds.length > 0)) {
			...
			for (int i = 0; i < parentCategoryIds.length; i++) {
				query.append(_FINDER_COLUMN_G_NOTC_P_PARENTCATEGORYID_5);
	...
	/**
	 * Returns all the message boards categories where groupId = &#63; and categoryId &ne; any &#63; and parentCategoryId = any &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.messageboards.model.impl.MBCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<MBCategory> findByG_NotC_P(long groupId, long[] categoryIds,
		long[] parentCategoryIds) throws SystemException {
		return findByG_NotC_P(groupId, categoryIds, parentCategoryIds,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	/**
	 * Returns a range of all the message boards categories where groupId = &#63; and categoryId &ne; any &#63; and parentCategoryId = any &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.messageboards.model.impl.MBCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<MBCategory> findByG_NotC_P(long groupId, long[] categoryIds,
		long[] parentCategoryIds, int start, int end) throws SystemException {
		return findByG_NotC_P(groupId, categoryIds, parentCategoryIds, start,
			end, null);
	}

	/**
	 * Returns an ordered range of all the message boards categories where groupId = &#63; and categoryId &ne; any &#63; and parentCategoryId = any &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.messageboards.model.impl.MBCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<MBCategory> findByG_NotC_P(long groupId, long[] categoryIds,
		...
		if ((categoryIds != null) && (categoryIds.length == 1) &&
			...
			return findByG_NotC_P(groupId, categoryIds[0],
		...
		List<MBCategory> list = (List<MBCategory>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_NOTC_P,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_NOTC_P,
					finderArgs, list);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_NOTC_P,
					finderArgs);
	...
	/**
	 * Removes all the message boards categories where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param categoryId the category ID
	 * @param parentCategoryId the parent category ID
	 ...
	 */
	@Override
	public void removeByG_NotC_P(long groupId, long categoryId,
		long parentCategoryId) throws SystemException {
		for (MBCategory mbCategory : findByG_NotC_P(groupId, categoryId,
	...
	/**
	 * Returns the number of message boards categories where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param categoryId the category ID
	 * @param parentCategoryId the parent category ID
	 ...
	 */
	@Override
	public int countByG_NotC_P(long groupId, long categoryId,
		long parentCategoryId) throws SystemException {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_NOTC_P;

		Object[] finderArgs = new Object[] { groupId, categoryId, parentCategoryId };
	...
	/**
	 * Returns the number of message boards categories where groupId = &#63; and categoryId &ne; any &#63; and parentCategoryId = any &#63;.
	 *
	 * @param groupId the group ID
	 * @param categoryIds the category IDs
	 * @param parentCategoryIds the parent category IDs
	 ...
	 */
	@Override
	public int countByG_NotC_P(long groupId, long[] categoryIds,
		long[] parentCategoryIds) throws SystemException {
		Object[] finderArgs = new Object[] {
				groupId, StringUtil.merge(categoryIds),
				StringUtil.merge(parentCategoryIds)
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_NOTC_P,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_NOTC_P,
					finderArgs, count);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_NOTC_P,
					finderArgs);
	...
	/**
	 * Returns the number of message boards categories that the user has permission to view where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param categoryId the category ID
	 * @param parentCategoryId the parent category ID
	 ...
	 */
	@Override
	public int filterCountByG_NotC_P(long groupId, long categoryId,
		long parentCategoryId) throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_NotC_P(groupId, categoryId, parentCategoryId);
		}
	...
	/**
	 * Returns the number of message boards categories that the user has permission to view where groupId = &#63; and categoryId &ne; any &#63; and parentCategoryId = any &#63;.
	 *
	 * @param groupId the group ID
	 * @param categoryIds the category IDs
	 * @param parentCategoryIds the parent category IDs
	 ...
	 */
	@Override
	public int filterCountByG_NotC_P(long groupId, long[] categoryIds,
		long[] parentCategoryIds) throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_NotC_P(groupId, categoryIds, parentCategoryIds);
		}
	...
	private static final String _FINDER_COLUMN_G_NOTC_P_GROUPID_2 = "mbCategory.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_NOTC_P_GROUPID_5 = "(" +
		removeConjunction(_FINDER_COLUMN_G_NOTC_P_GROUPID_2) + ")";
	private static final String _FINDER_COLUMN_G_NOTC_P_CATEGORYID_2 = "mbCategory.categoryId != ? AND ";
	private static final String _FINDER_COLUMN_G_NOTC_P_CATEGORYID_5 = "(" +
		removeConjunction(_FINDER_COLUMN_G_NOTC_P_CATEGORYID_2) + ")";
	private static final String _FINDER_COLUMN_G_NOTC_P_PARENTCATEGORYID_2 = "mbCategory.parentCategoryId = ?";
	private static final String _FINDER_COLUMN_G_NOTC_P_PARENTCATEGORYID_5 = "(" +
		removeConjunction(_FINDER_COLUMN_G_NOTC_P_PARENTCATEGORYID_2) + ")";
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_NOTC_P_S =
		new FinderPath(MBCategoryModelImpl.ENTITY_CACHE_ENABLED,
			MBCategoryModelImpl.FINDER_CACHE_ENABLED, MBCategoryImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_NotC_P_S",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName(),
				Integer.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_NOTC_P_S =
		new FinderPath(MBCategoryModelImpl.ENTITY_CACHE_ENABLED,
			MBCategoryModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByG_NotC_P_S",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName(),
				Integer.class.getName()
			});
	...
	/**
	 * Returns all the message boards categories where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63; and status = &#63;.
	 *
	 * @param groupId the group ID
	 * @param categoryId the category ID
	 * @param parentCategoryId the parent category ID
	 ...
	 */
	@Override
	public List<MBCategory> findByG_NotC_P_S(long groupId, long categoryId,
		long parentCategoryId, int status) throws SystemException {
		return findByG_NotC_P_S(groupId, categoryId, parentCategoryId, status,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the message boards categories where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.messageboards.model.impl.MBCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the message boards categories where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.messageboards.model.impl.MBCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<MBCategory> findByG_NotC_P_S(long groupId, long categoryId,
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_G_NOTC_P_S;
		finderArgs = new Object[] {
				groupId, categoryId, parentCategoryId, status,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_NOTC_P_S_GROUPID_2);

			query.append(_FINDER_COLUMN_G_NOTC_P_S_CATEGORYID_2);

			query.append(_FINDER_COLUMN_G_NOTC_P_S_PARENTCATEGORYID_2);

			query.append(_FINDER_COLUMN_G_NOTC_P_S_STATUS_2);
	...
	/**
	 * Returns the first message boards category in the ordered set where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63; and status = &#63;.
	 *
	 * @param groupId the group ID
	 * @param categoryId the category ID
	 * @param parentCategoryId the parent category ID
	 ...
	 */
	@Override
	public MBCategory findByG_NotC_P_S_First(long groupId, long categoryId,
		long parentCategoryId, int status, OrderByComparator orderByComparator)
		throws NoSuchCategoryException, SystemException {
		MBCategory mbCategory = fetchByG_NotC_P_S_First(groupId, categoryId,
				parentCategoryId, status, orderByComparator);
	 ...
	 */
	@Override
	public MBCategory fetchByG_NotC_P_S_First(long groupId, long categoryId,
		long parentCategoryId, int status, OrderByComparator orderByComparator)
		throws SystemException {
		List<MBCategory> list = findByG_NotC_P_S(groupId, categoryId,
	...
	/**
	 * Returns the last message boards category in the ordered set where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63; and status = &#63;.
	 *
	 * @param groupId the group ID
	 * @param categoryId the category ID
	 * @param parentCategoryId the parent category ID
	 ...
	 */
	@Override
	public MBCategory findByG_NotC_P_S_Last(long groupId, long categoryId,
		long parentCategoryId, int status, OrderByComparator orderByComparator)
		throws NoSuchCategoryException, SystemException {
		MBCategory mbCategory = fetchByG_NotC_P_S_Last(groupId, categoryId,
				parentCategoryId, status, orderByComparator);
	 ...
	 */
	@Override
	public MBCategory fetchByG_NotC_P_S_Last(long groupId, long categoryId,
		long parentCategoryId, int status, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByG_NotC_P_S(groupId, categoryId, parentCategoryId,
				status);
	...
	/**
	 * Returns all the message boards categories that the user has permission to view where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63; and status = &#63;.
	 *
	 * @param groupId the group ID
	 * @param categoryId the category ID
	 * @param parentCategoryId the parent category ID
	 ...
	 */
	@Override
	public List<MBCategory> filterFindByG_NotC_P_S(long groupId,
		long categoryId, long parentCategoryId, int status)
		throws SystemException {
		return filterFindByG_NotC_P_S(groupId, categoryId, parentCategoryId,
			status, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the message boards categories that the user has permission to view where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.messageboards.model.impl.MBCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	@Override
	public List<MBCategory> filterFindByG_NotC_P_S(long groupId,
		long categoryId, long parentCategoryId, int status, int start, int end)
		throws SystemException {
		return filterFindByG_NotC_P_S(groupId, categoryId, parentCategoryId,
	...
	/**
	 * Returns an ordered range of all the message boards categories that the user has permissions to view where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.messageboards.model.impl.MBCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<MBCategory> filterFindByG_NotC_P_S(long groupId,
		...
		OrderByComparator orderByComparator) throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_NotC_P_S(groupId, categoryId, parentCategoryId,
	...
	/**
	 * Returns all the message boards categories that the user has permission to view where groupId = &#63; and categoryId &ne; any &#63; and parentCategoryId = any &#63; and status = &#63;.
	 *
	 * @param groupId the group ID
	 * @param categoryIds the category IDs
	 * @param parentCategoryIds the parent category IDs
	...
	@Override
	public List<MBCategory> filterFindByG_NotC_P_S(long groupId,
		long[] categoryIds, long[] parentCategoryIds, int status)
		throws SystemException {
		return filterFindByG_NotC_P_S(groupId, categoryIds, parentCategoryIds,
			status, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the message boards categories that the user has permission to view where groupId = &#63; and categoryId &ne; any &#63; and parentCategoryId = any &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.messageboards.model.impl.MBCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	@Override
	public List<MBCategory> filterFindByG_NotC_P_S(long groupId,
		long[] categoryIds, long[] parentCategoryIds, int status, int start,
		int end) throws SystemException {
		return filterFindByG_NotC_P_S(groupId, categoryIds, parentCategoryIds,
			status, start, end, null);
	}
	...
	/**
	 * Returns an ordered range of all the message boards categories that the user has permission to view where groupId = &#63; and categoryId &ne; any &#63; and parentCategoryId = any &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.messageboards.model.impl.MBCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<MBCategory> filterFindByG_NotC_P_S(long groupId,
		...
		int end, OrderByComparator orderByComparator) throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_NotC_P_S(groupId, categoryIds, parentCategoryIds,
				status, start, end, orderByComparator);
		}
		...
		query.append(_FINDER_COLUMN_G_NOTC_P_S_GROUPID_5);
		...
		if ((categoryIds == null) || (categoryIds.length > 0)) {
			...
			for (int i = 0; i < categoryIds.length; i++) {
				query.append(_FINDER_COLUMN_G_NOTC_P_S_CATEGORYID_5);
		...
		if ((parentCategoryIds == null) || (parentCategoryIds.length > 0)) {
			...
			for (int i = 0; i < parentCategoryIds.length; i++) {
				query.append(_FINDER_COLUMN_G_NOTC_P_S_PARENTCATEGORYID_5);
		...
		query.append(_FINDER_COLUMN_G_NOTC_P_S_STATUS_5);
	...
	/**
	 * Returns all the message boards categories where groupId = &#63; and categoryId &ne; any &#63; and parentCategoryId = any &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.messageboards.model.impl.MBCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<MBCategory> findByG_NotC_P_S(long groupId, long[] categoryIds,
		long[] parentCategoryIds, int status) throws SystemException {
		return findByG_NotC_P_S(groupId, categoryIds, parentCategoryIds,
			status, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	/**
	 * Returns a range of all the message boards categories where groupId = &#63; and categoryId &ne; any &#63; and parentCategoryId = any &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.messageboards.model.impl.MBCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the message boards categories where groupId = &#63; and categoryId &ne; any &#63; and parentCategoryId = any &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portlet.messageboards.model.impl.MBCategoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<MBCategory> findByG_NotC_P_S(long groupId, long[] categoryIds,
		...
		if ((categoryIds != null) && (categoryIds.length == 1) &&
				(parentCategoryIds != null) && (parentCategoryIds.length == 1)) {
			return findByG_NotC_P_S(groupId, categoryIds[0],
		...
		List<MBCategory> list = (List<MBCategory>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_NOTC_P_S,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_NOTC_P_S,
					finderArgs, list);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_NOTC_P_S,
					finderArgs);
	...
	/**
	 * Removes all the message boards categories where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63; and status = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param categoryId the category ID
	 * @param parentCategoryId the parent category ID
	 ...
	 */
	@Override
	public void removeByG_NotC_P_S(long groupId, long categoryId,
		long parentCategoryId, int status) throws SystemException {
		for (MBCategory mbCategory : findByG_NotC_P_S(groupId, categoryId,
	...
	/**
	 * Returns the number of message boards categories where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63; and status = &#63;.
	 *
	 * @param groupId the group ID
	 * @param categoryId the category ID
	 * @param parentCategoryId the parent category ID
	 ...
	 */
	@Override
	public int countByG_NotC_P_S(long groupId, long categoryId,
		long parentCategoryId, int status) throws SystemException {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_NOTC_P_S;
	...
	/**
	 * Returns the number of message boards categories where groupId = &#63; and categoryId &ne; any &#63; and parentCategoryId = any &#63; and status = &#63;.
	 *
	 * @param groupId the group ID
	 * @param categoryIds the category IDs
	 * @param parentCategoryIds the parent category IDs
	 ...
	 */
	@Override
	public int countByG_NotC_P_S(long groupId, long[] categoryIds,
		long[] parentCategoryIds, int status) throws SystemException {
		Object[] finderArgs = new Object[] {
				groupId, StringUtil.merge(categoryIds),
				StringUtil.merge(parentCategoryIds), status
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_NOTC_P_S,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_NOTC_P_S,
					finderArgs, count);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_NOTC_P_S,
					finderArgs);
	...
	/**
	 * Returns the number of message boards categories that the user has permission to view where groupId = &#63; and categoryId &ne; &#63; and parentCategoryId = &#63; and status = &#63;.
	 *
	 * @param groupId the group ID
	 * @param categoryId the category ID
	 * @param parentCategoryId the parent category ID
	 ...
	 */
	@Override
	public int filterCountByG_NotC_P_S(long groupId, long categoryId,
		long parentCategoryId, int status) throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_NotC_P_S(groupId, categoryId, parentCategoryId,
				status);
		}
	...
	/**
	 * Returns the number of message boards categories that the user has permission to view where groupId = &#63; and categoryId &ne; any &#63; and parentCategoryId = any &#63; and status = &#63;.
	 *
	 * @param groupId the group ID
	 * @param categoryIds the category IDs
	 * @param parentCategoryIds the parent category IDs
	 ...
	 */
	@Override
	public int filterCountByG_NotC_P_S(long groupId, long[] categoryIds,
		long[] parentCategoryIds, int status) throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_NotC_P_S(groupId, categoryIds, parentCategoryIds,
				status);
		}
	...
	private static final String _FINDER_COLUMN_G_NOTC_P_S_GROUPID_2 = "mbCategory.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_NOTC_P_S_GROUPID_5 = "(" +
		removeConjunction(_FINDER_COLUMN_G_NOTC_P_S_GROUPID_2) + ")";
	private static final String _FINDER_COLUMN_G_NOTC_P_S_CATEGORYID_2 = "mbCategory.categoryId != ? AND ";
	private static final String _FINDER_COLUMN_G_NOTC_P_S_CATEGORYID_5 = "(" +
		removeConjunction(_FINDER_COLUMN_G_NOTC_P_S_CATEGORYID_2) + ")";
	private static final String _FINDER_COLUMN_G_NOTC_P_S_PARENTCATEGORYID_2 = "mbCategory.parentCategoryId = ? AND ";
	private static final String _FINDER_COLUMN_G_NOTC_P_S_PARENTCATEGORYID_5 = "(" +
		removeConjunction(_FINDER_COLUMN_G_NOTC_P_S_PARENTCATEGORYID_2) + ")";
	private static final String _FINDER_COLUMN_G_NOTC_P_S_STATUS_2 = "mbCategory.status = ?";
	private static final String _FINDER_COLUMN_G_NOTC_P_S_STATUS_5 = "(" +
		removeConjunction(_FINDER_COLUMN_G_NOTC_P_S_STATUS_2) + ")";
