...
@OSGiBeanProperties(
	property = {
		...
		"mvc.command.name=/document_library_display/select_add_file_entry_type"
	},
	service = MVCRenderCommand.class
)
public class SelectAddFileEntryTypeMVCRenderCommand
	extends BaseJSPMVCRenderCommand {

	public SelectAddFileEntryTypeMVCRenderCommand() {
		super(
