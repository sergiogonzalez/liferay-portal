...
@OSGiBeanProperties(
	property = {
		...
		"render.command.name=/document_library_display/search"
	},
	service = ActionCommand.class
)
public class SearchRenderCommand implements RenderCommand {
	...
	public String processCommand(
		...
		return "/html/portlet/document_library_display/search.jsp";
	}
