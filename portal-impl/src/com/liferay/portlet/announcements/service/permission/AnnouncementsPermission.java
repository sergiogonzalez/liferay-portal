 ...
 */
@OSGiBeanProperties(
	property = {"resource.name=" + AnnouncementsPermission.RESOURCE_NAME}
)
public class AnnouncementsPermission extends BaseResourcePermissionChecker {

	public static final String RESOURCE_NAME = "com.liferay.announcements";
